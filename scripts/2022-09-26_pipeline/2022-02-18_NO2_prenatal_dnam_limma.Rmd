...
# save 
save(sv_cb, file = here("output_data", "linear_regression", "2022-05-25_prenatal_svs.RData"))
...
ggsave(plot = cb_sv_scree, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal", 
                       "2022-05-25_cb_sv_heat_scree.png"),
...
ggsave(plot = svcorr,
       filename = here("figures",
                       "linear_regression",
                       "prenatal", 
                       "2022-05-25_sv_correlations.png"),
...
ggsave(plot = bacon_before_after, 
       filename= here("figures", 
                      "linear_regression", 
                      "prenatal", 
                      "2022-05-25_cb_bacon_before_after.png"),
...
ggsave(plot = before_qqplot, 
       filename= here("figures", 
                      "linear_regression", 
                      "prenatal", 
                      "2022-05-25_uncorrected_qqplot.png"),
...
ggsave(plot = after_qqplot, 
       filename= here("figures", 
                      "linear_regression", 
                      "prenatal", 
                      "2022-05-25_bacon_corrected_qqplot.png"),
       width = 6, height = 5, units = "cm")
```
...
covariates_geno_ctpc_tech_cc$cb_cg12228123_100 <-
  covariates_geno_ctpc_tech_cc$cb_cg12228123*100
...
# wheeze logistic
cg12228123_wheeze_log <- glm(any_wheeze_y1 ~ cb_cg12228123_100 +
                               sex + gestational_days + pss_18wk +
                               prenatal_maternal_smoking + maternal_education_length + 
                               cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                               genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# atopy logistic
cg12228123_atopy_log <- glm(clinician_atopy_dx_y1 ~ cb_cg12228123_100 +
                              sex + gestational_days + pss_18wk +
                              prenatal_maternal_smoking + maternal_education_length + 
                              cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                              genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
covariates_geno_ctpc_tech_cc$cb_cg27481559_100 <-
  covariates_geno_ctpc_tech_cc$cb_cg27481559*100
