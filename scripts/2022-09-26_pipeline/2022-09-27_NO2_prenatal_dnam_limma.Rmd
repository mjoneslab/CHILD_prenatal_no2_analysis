...
# dmr1_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr7", 
#                                track = "Broad ChromHMM",
#                                table = "wgEncodeBroadHmmK562HMM",
#                                trackType = "AnnotationTrack", 
#                                from = 27146628, 
#                                to  =  27195547,
#                                start = "chromStart", end = "chromEnd", 
...
#                                name = "K562")
# 
# dmr1_chromHmmk562@dp@pars$fill <- recode(dmr1_chromHmmk562@dp@pars$fill,
#                                          "127,127,127" = "#7f7f7f",
#                                          "245,245,245" = "#f5f5f5",
#                                          "10,190,254"  = "#0abefe")
...
dmr2_charm <- 
  ...
  geom_point(longdf_dmr2 %>% 
             ...
             size = 0.25, alpha = 0.8) +
  theme_bw() +
  scale_x_continuous(name = "Genomic position", breaks = seq(27187200, 27187600,by=200)) +
  scale_y_continuous(name = "DNA methylation (%)") +
  theme(axis.text = element_text(size = 9, family = "sans"),
        axis.title = element_text(size = 9, family = "sans"),
        panel.grid = element_blank(),
...
dmr2_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr7", 
                               track = "Broad ChromHMM",
                               table = "wgEncodeBroadHmmK562HMM",
                               trackType = "AnnotationTrack", 
                               from = 27146628, 
...
dmr2_chromHmmk562@dp@pars$fill <- recode(dmr2_chromHmmk562@dp@pars$fill,
                                         "127,127,127" = "#7f7f7f",
                                         "245,245,245" = "#f5f5f5",
                                         "10,190,254"  = "#0abefe",
                                         "250,202,0" = "#faca00")
...
dmr3_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr8", 
                               track = "Broad ChromHMM",
                               table = "wgEncodeBroadHmmK562HMM",
                               trackType = "AnnotationTrack", 
                               from = 22110000, 
...
dmr3_chromHmmk562@dp@pars$fill <- recode(dmr3_chromHmmk562@dp@pars$fill,
                                         "127,127,127" = "#7f7f7f",
                                         "245,245,245" = "#f5f5f5",
                                         "10,190,254"  = "#0abefe",
                                         "250,202,0" = "#faca00",
...
dmr4_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr17", 
                               track = "Broad ChromHMM",
                               table = "wgEncodeBroadHmmK562HMM",
                               trackType = "AnnotationTrack", 
                               from = 36580000, 
...
dmr4_chromHmmk562@dp@pars$fill <- recode(dmr4_chromHmmk562@dp@pars$fill,
                                         "127,127,127" = "#7f7f7f",
                                         "245,245,245" = "#f5f5f5",
                                         "10,190,254"  = "#0abefe",
                                         "250,202,0" = "#faca00",
...
dmr5_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr5", 
                               track = "Broad ChromHMM",
                               table = "wgEncodeBroadHmmK562HMM",
                               trackType = "AnnotationTrack", 
                             from = 150290000,
...
dmr5_chromHmmk562@dp@pars$fill <- recode(dmr5_chromHmmk562@dp@pars$fill,
                                         "127,127,127" = "#7f7f7f",
                                         "245,245,245" = "#f5f5f5",
                                         "10,190,254"  = "#0abefe",
                                         "250,202,0" = "#faca00",
...
dmr6_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr2", 
                               track = "Broad ChromHMM",
                               table = "wgEncodeBroadHmmK562HMM",
                               trackType = "AnnotationTrack", 
                               from = dmr6_from, 
...
dmr6_chromHmmk562@dp@pars$fill <- recode(dmr6_chromHmmk562@dp@pars$fill,
                                         "127,127,127" = "#7f7f7f",
                                         "245,245,245" = "#f5f5f5",
                                         "10,190,254"  = "#0abefe",
                                         "250,202,0" = "#faca00",
...
dmr7_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr7", 
                               track = "Broad ChromHMM",
                               table = "wgEncodeBroadHmmK562HMM",
                               trackType = "AnnotationTrack", 
                               from = 26797182,
...
dmr7_chromHmmk562@dp@pars$fill <- recode(dmr7_chromHmmk562@dp@pars$fill,
                                         "127,127,127" = "#7f7f7f",
                                         "245,245,245" = "#f5f5f5",
                                         "10,190,254"  = "#0abefe",
                                         "250,202,0" = "#faca00",
...
dmr8_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr1", 
                               track = "Broad ChromHMM",
                               table = "wgEncodeBroadHmmK562HMM",
                               trackType = "AnnotationTrack", 
                               from = 248099345,
...
dmr8_chromHmmk562@dp@pars$fill <- recode(dmr8_chromHmmk562@dp@pars$fill,
                                         "127,127,127" = "#7f7f7f",
                                         "245,245,245" = "#f5f5f5",
                                         "10,190,254"  = "#0abefe",
                                         "250,202,0" = "#faca00",
...
dmr9_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr17", 
                               track = "Broad ChromHMM",
                               table = "wgEncodeBroadHmmK562HMM",
                               trackType = "AnnotationTrack", 
                               from = 46665500,
...
dmr9_chromHmmk562@dp@pars$fill <- recode(dmr9_chromHmmk562@dp@pars$fill,
                                         "127,127,127" = "#7f7f7f",
                                         "245,245,245" = "#f5f5f5",
                                         "10,190,254"  = "#0abefe",
                                         "250,202,0" = "#faca00",
...
dmr10_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr7", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = dmr10_from,
...
dmr10_chromHmmk562@dp@pars$fill <- recode(dmr10_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr11_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr10", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = 134834613,
...
dmr11_chromHmmk562@dp@pars$fill <- recode(dmr11_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr12_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr2", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = 53900000,
...
dmr12_chromHmmk562@dp@pars$fill <- recode(dmr12_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr13_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr19", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = dmr13_from,
...
dmr13_chromHmmk562@dp@pars$fill <- recode(dmr13_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr14_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr11", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = 75133000,
...
dmr14_chromHmmk562@dp@pars$fill <- recode(dmr14_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr15_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr1", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = 216700000,
...
dmr15_chromHmmk562@dp@pars$fill <- recode(dmr15_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr16_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr4", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = 3320000,
...
dmr16_chromHmmk562@dp@pars$fill <- recode(dmr16_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr18_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr12", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = 113775000,
...
dmr18_chromHmmk562@dp@pars$fill <- recode(dmr18_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr19_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr6", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = dmr19_from,
...
dmr19_chromHmmk562@dp@pars$fill <- recode(dmr19_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr20_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr15", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = dmr20_from,
...
dmr20_chromHmmk562@dp@pars$fill <- recode(dmr20_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr21_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr6", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = 164390000,
...
dmr21_chromHmmk562@dp@pars$fill <- recode(dmr21_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr23_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr17", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = dmr23_from,
...
dmr23_chromHmmk562@dp@pars$fill <- recode(dmr23_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr24_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr7", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = dmr24_from,
...
dmr24_chromHmmk562@dp@pars$fill <- recode(dmr24_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr25_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr5", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = dmr25_from,
...
dmr25_chromHmmk562@dp@pars$fill <- recode(dmr25_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
...
dmr27_chromHmmk562 <- UcscTrack(genome = "hg19", chromosome = "chr5", 
                                track = "Broad ChromHMM",
                                table = "wgEncodeBroadHmmK562HMM",
                                trackType = "AnnotationTrack", 
                                from = 126380000,
...
dmr27_chromHmmk562@dp@pars$fill <- recode(dmr27_chromHmmk562@dp@pars$fill,
                                          "127,127,127" = "#7f7f7f",
                                          "245,245,245" = "#f5f5f5",
                                          "10,190,254"  = "#0abefe",
                                          "250,202,0" = "#faca00",
