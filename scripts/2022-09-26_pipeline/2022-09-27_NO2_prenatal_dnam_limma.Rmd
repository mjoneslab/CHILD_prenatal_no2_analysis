...
colnames(covariates_geno_ctpc_tech_cc)[140:156] <-
  paste("sv",colnames(covariates_geno_ctpc_tech_cc)[140:156], sep="")
...
meta_categorical <- 
  covariates_geno_ctpc_tech_cc[,c("sex", "prenatal_maternal_smoke",
                                  "run", "chip")] 
meta_continuous <- 
  covariates_geno_ctpc_tech_cc[,c("no2_prenatal_avg_2019v",
                                  "gestational_age", 
                                  "maternal_education_length", 
                                  "pss_pre18wk", "csed_pre18wk","row", "Comp.1", 
...
ggsave(plot = qqplot, 
       filename= here("figures", 
                      "linear_regression", 
                      "prenatal", 
                      "2022-10-05_prenatal_no2_qqplot.png"),
...
cb_volcano <- ggplot(cb_pvals_tech, 
                     aes(x=as.numeric(effect_size) , 
                         y=-log10(as.numeric(pval_no2_prenatal_avg_2019v_bacon)))) +
  ...
  geom_point(data=subset(cb_pvals_tech, 
                         (pval_no2_prenatal_avg_2019v_adj < 0.25 & effect_size > 0.025) | 
                           (pval_no2_prenatal_avg_2019v_adj < 0.25 & effect_size < -0.025)), 
...
ggsave(plot = cb_cg12283362_dnam_plot, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-10-05_cb_cg12283362_dnam.png"),
...
ggsave(plot = cb_cg08973675_dnam_plot, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-10-05_cb_cg08973675_dnam.png"),
       width = 4.0, height = 3.2, units = "cm")
...
# dmr 1 has positive effect size - use greater
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean1),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean1),
       alternative ="greater") # p-value = 0.02714
...
# dmr 1 has positive effect size - use greater
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean2),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean2),
       alternative ="greater") # p-value = 0.05477
...
# dmr 3 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean3),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean3),
       alternative ="less") # p-value = 0.05833
...
# dmr 4 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean4),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean4),
       alternative ="greater") # p-value = 0.4593
...
# dmr 5 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean5),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean5),
       alternative ="less") #  p-value = 0.1889
...
# dmr 6 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean6),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean6),
       alternative ="less") # p-value = 0.6504
...
# dmr 7 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean7),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean7),
       alternative ="greater") # p-value = 0.6246
...
# dmr 8 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean8),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean8),
       alternative ="less") # p-value = 0.4983
...
# dmr 9 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean9),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean9),
       alternative ="greater") # p-value = 0.8013
...
# dmr 10 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean10),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean10),
       alternative ="less") # p-value = 0.09656
...
# dmr 11 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean11),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean11),
       alternative ="less") # p-value = 0.4334
...
# dmr 13 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean13),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean13),
       alternative ="greater") # p-value = 0.6585
...
# dmr 14 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean14),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean14),
       alternative ="less") # p-value = 0.02371
...
# dmr 15 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean15),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean15),
       alternative ="greater") # p-value = 0.2506
...
# dmr 16 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean16),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean16),
       alternative ="greater") # p-value = 0.722
...
# dmr 18 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean18),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean18),
       alternative ="less") # p-value = 0.4439
...
# dmr 19 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean19),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean19),
       alternative ="greater") # p-value = 0.5216
...
# dmr 20 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean20),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean20),
       alternative ="less") # p-value = 0.8672
...
# dmr 21 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean21),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean21),
       alternative ="greater") # p-value = 0.4675
...
# dmr 23 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean23),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean23),
       alternative ="greater") # p-value = 0.9899
...
ggplot(covariates_geno_ctpc_tech_cc %>% subset(!is.na(any_wheeze_y1)),
       aes(x=as.factor(any_wheeze_y1), y=dmrmean24)) +
  geom_boxplot()

# dmr 24 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean24),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean24),
       alternative ="less") # p-value = 0.08451
...
# dmr 25 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean25),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean25),
       alternative ="greater") # p-value = 0.8645
...
ggplot(covariates_geno_ctpc_tech_cc %>% subset(!is.na(any_wheeze_y1)),
       aes(x=as.factor(any_wheeze_y1), y=dmrmean27)) +
  geom_boxplot()

# dmr 27 one sided t test
t.test(x= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==T) %>% pull(dmrmean27),
       y= covariates_geno_ctpc_tech_cc %>% subset(any_wheeze_y1==F) %>% pull(dmrmean27),
       alternative ="less") # p-value = 0.01361
```
...
cg12228123_nobm_lm <- lm(cb_cg12228123 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg12228123_bm_lm, cg12228123_nobm_lm) # p = 0.1439
summary(cg12228123_bm_lm)
...
# fit wiht lm
cg27481559_nobm_lm <- lm(cb_cg27481559 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg27481559_bm_lm, cg27481559_nobm_lm) # p = 0.7697
summary(cg27481559_bm_lm)
...
# fit wiht lm
cg22230559_nobm_lm <- lm(cb_cg22230559 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg22230559_bm_lm, cg22230559_nobm_lm) # p = 0.1098
summary(cg22230559_bm_lm)
...
cg05231970_nobm_lm <- lm(cb_cg05231970 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg05231970_bm_lm, cg05231970_nobm_lm) # p = 0.661
summary(cg05231970_bm_lm) # july is significant
...
# fit wiht lm
cg26787539_nobm_lm <- lm(cb_cg26787539 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg26787539_bm_lm, cg26787539_nobm_lm) # p = 0.7721
summary(cg26787539_bm_lm)
...
cg08568767_nobm_lm <- lm(cb_cg08568767 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg08568767_bm_lm, cg08568767_nobm_lm) # 0.9935
summary(cg08568767_bm_lm) # birth months are ns
...
# fit wiht lm
cg02386875_nobm_lm <- lm(cb_cg02386875 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg02386875_bm_lm, cg02386875_nobm_lm) # p = 0.04354 
summary(cg02386875_bm_lm) # march is significant
...
cg04256907_nobm_lm <- lm(cb_cg04256907 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg04256907_bm_lm, cg04256907_nobm_lm) # p = 0.2425
summary(cg04256907_bm_lm) # birth months are ns
...
# fit wiht lm
cg10920410_nobm_lm <- lm(cb_cg10920410 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg10920410_bm_lm, cg10920410_nobm_lm) # p = 0.2841
summary(cg10920410_bm_lm) # may, august, october are sig, june and sept trending
...
# fit wiht lm
cg03392571_nobm_lm <- lm(cb_cg03392571 ~ 
                           no2_preg_entire + sex + gestational_days + pss_18wk +
                           prenatal_maternal_smoking + maternal_education_length + 
                           cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4  + 
                           genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
# anova
anova(cg03392571_bm_lm, cg03392571_nobm_lm) # p = 0.1311
summary(cg03392571_bm_lm) # march and june sig, november trending
...
identical(rownames(child_fscbc_ecc2_), 
          rownames(cb_pdata))
...
# table 1
table1(~sex + gestational_days + no2_preg_entire + 
...
# this matrix does not include any of our covariates 
# this means that our covariates are "protected" and SVs will not capture them
y1_mod0 <- model.matrix(~ sex + maternal_smoking_y1 +
                          maternal_education_length +
                          pbmc.Comp.1 + pbmc.Comp.2 + pbmc.Comp.3 +
                          genotyping.PC1 + genotyping.PC2 + genotyping.PC3, 
                        data=covariates_geno_ctpc_tech_cc_y1_sub)
...
### Linear regressions examining persistence at significant CpGs/DMRs
...
### Examine changes in effect size over the first year of life 
