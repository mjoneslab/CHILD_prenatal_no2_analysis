...
#remove probe info as it's not needed at this time
rm(cb_allprobes, cb_deconvolutionprobes,
   y1_allprobes, y1_deconvolutionprobes)
```


## Dataa prepartion for cell type correction 
...
diff_betas_design <- model.matrix(~ PC1  + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9, 
                              data=ccc_pcs)
...
y1_mvals <- lumi::beta2m(diff_betas)
