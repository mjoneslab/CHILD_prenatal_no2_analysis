...
ggplot(diff_pvals_tech, aes(x=as.numeric(db)*100 , y=-log10(as.numeric(pval_no2_y1_entire)))) +
  geom_point(alpha=0.4, col = "#254A90", size=3) +
...
covariates_geno_ctpcs_tech_cc$cg19011826 <- diff_betas_geno_cc_cpr[rownames(diff_betas_geno_cc_cpr)=="cg19011826", ]

cg19011826_lm <- lm(cg19011826 ~ no2_y1_entire + sex +
...
cg19011826_res <- partialResid(cg19011826 ~ no2_y1_entire, 
                               cg19011826_lm, 
                               data=covariates_geno_ctpcs_tech_cc)

#fit again to get r2
cg19011826_res_fit <- lm(cg19011826_res$yresid ~ cg19011826_res$xresid)

summary(cg19011826_lm)

ggplot(cg19011826_res, aes(x=xresid, y=yresid)) + 
  geom_point(alpha=0.8, fill = "#254A90", shape=21, size=3) + 
  stat_smooth(method="lm", se=F, col="red") + 
  theme_bw() +
  labs(x=bquote("Postnatal" ~NO[2]~ "(ppb) partial residual"), 
       y="Methylation (%) partial residual") +
  annotate("text",x=7,y=0.06, label="slope = 0.202", size=4) +
  ggtitle("cg19011826") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
...
cg07472943_lm <- lm(cg07472943 ~ no2_y1_entire + sex +
              maternal_smoking_y1 + maternal_education_length +
              pss_6mos + csed_6mos + 
              celltype.PC1 + celltype.PC2 + 
              celltype.PC3 + celltype.PC4 + 
...
ggplot(cg07472943_res, aes(x=xresid, y=yresid)) + 
  ...
  labs(x=bquote("Postnatal" ~NO[2]~ "(ppb) partial residual"), 
       y="Methylation (%) partial residual") +
  annotate("text",x=7,y=0.06, label="slope = -0.132", size=4) +
  ggtitle("cg07472943") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        axis.text = element_text(size=19),
...
covariates_geno_ctpcs_tech_cc$cg24353392 <- diff_betas_geno_cc_cpr[rownames(diff_betas_geno_cc_cpr)=="cg24353392", ]

cg24353392_lm <- lm(cg24353392 ~ no2_y1_entire + sex +
              maternal_smoking_y1 + maternal_education_length +
              pss_6mos + csed_6mos + 
              celltype.PC1 + celltype.PC2 + 
              celltype.PC3 + celltype.PC4 + 
...
ggplot(cg24353392_res, aes(x=xresid, y=yresid)) + 
  ...
  labs(x=bquote("Postnatal" ~NO[2]~ "(ppb) partial residual"), 
       y="Methylation (%) partial residual") +
  annotate("text",x=7,y=0.06, label="slope = -0.136", size=4) +
  ggtitle("cg24353392") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        axis.text = element_text(size=19),
...
ggplot(cg18668679_res, aes(x=xresid, y=yresid)) + 
  ...
  labs(x=bquote("Postnatal" ~NO[2]~ "(ppb) partial residual"), 
       y="Methylation (%) partial residual") +
  annotate("text",x=7,y=0.06, label="slope = -0.165", size=4) +
  ggtitle("cg18668679") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        axis.text = element_text(size=19),
...
linemeth_lm <- lm(linemeth ~ no2_y1_entire + 
              ...
              sv5 + sv6 + sv7 + sv8 + 
              sv9 + sv10 + sv11 + sv12 +
                sv13 + sv14 + sv15, data=covariates_geno_ctpcs_tech_cc)
