...
#remove cell percentages as they aren't needed
rm(child_fscbc_ecc2_y1, child_fscbc_ecc2_cb)
```
...
#fit again to get r2
y1_cg15325658_res_fit <- lm(y1_cg15325658_res$yresid ~ y1_cg15325658_res$xresid)

summary(y1_cg15325658_res_fit)
...
ggplot(y1_cg15325658_res, aes(x=xresid, y=yresid)) + 
  ...
  labs(x="Prenatal NO2 (ppb)", 
       y=str_wrap("(ROBO1) cg15325658 DNA methyaltion (%)",width=35)) +
...
#fit again to get r2
y1_cg16404170_res_fit <- lm(y1_cg16404170_res$yresid ~ y1_cg16404170_res$xresid)

summary(y1_cg16404170_res_fit)
...
ggplot(y1_cg16404170_res, aes(x=xresid, y=yresid)) + 
  ...
  theme_bw() +
  labs(x="Prenatal NO2 (ppb)", 
       y=str_wrap("(FAM53B) cg16404170 DNA methyaltion (%)",width=35)) +
  ggtitle("Partial residual plot") +
  theme(panel.border=element_blank(),
        axis.text = element_text(size=12),
        axis.title = element_text(size=14),
...
#fit again to get r2
y1_cg20430496_res_fit <- lm(y1_cg20430496_res$yresid ~ y1_cg20430496_res$xresid)

summary(y1_cg20430496_res_fit)
...
ggplot(y1_cg20430496_res, aes(x=xresid, y=yresid)) + 
  ...
  theme_bw() +
  labs(x="Prenatal NO2 (ppb)", 
       y=str_wrap("(FAM53B) cg20430496 DNA methyaltion (%)",width=35)) +
  ggtitle("Partial residual plot") +
  theme(panel.border=element_blank(),
        axis.text = element_text(size=12),
        axis.title = element_text(size=14),
...
ggplot(cg24172570_res, aes(x=xresid, y=yresid)) + 
  ...
  theme_bw() +
  labs(x="Prenatal NO2 (ppb)", 
       y=str_wrap("3-hydroxyisobutyrate dehydrogenase (HIBADH) cg24172570 DNA methyaltion (%)",width=35)) +
  ggtitle("Partial residual plot") +
  theme(panel.border=element_blank(),
        axis.text = element_text(size=12),
        axis.title = element_text(size=14),
