...
ggplot(pval_qq, aes(x=e, y=o)) + 
  ...
  ggsave( filename="2021-03-17_CHILD_cb_qqplot.png",
...
ggplot(cb_pvals_tech, aes(x=as.numeric(db)*100 , y=-log10(as.numeric(pval_no2_preg_entire)))) +
  geom_point(alpha=0.4, col = "#254A90", size=2) +
  ...
  ggsave( filename="2021-03-17_CHILD_cb_volcanoplot.png",
          path =  here("figures", "linear_regression", "prenatal"),
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=12),
        axis.title = element_blank()) +
  ggsave(filename="2021-03-28_CHILD_cb_cg05732646_KBTBD6.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3, height = 2.1, units = "in")
...
ggplot(cb_cg22908922_res, aes(x=xresid, y=yresid)) + 
  ...
  ylim(-0.2, 0.2) +
  xlim(-16.5, 14) +
  ggsave(filename="2021-03-17_CHILD_cb_cg22908922_PACS2.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
  ylim(0.5, 0.9) +
  ggsave(filename="2021-03-28_CHILD_cb_cb_cg22908922_PACS2.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
     ylim(0.5, 0.99) +
  ggsave(filename="2021-03-28_CHILD_cb_cg12228123_AFAP1.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3, height = 2.1, units = "in")
...
# rename columns with svs
colnames(covariates_geno_ctpc_tech_cc_y1_sub)[158:172] <-
  paste("y1sv",colnames(covariates_geno_ctpc_tech_cc_y1_sub)[158:172], sep="")
...
# use 9 SVs 
y1_modSv = cbind(y1_mod,svobj$sv[,1:9])
...
colnames(y1_pvals_tech) <- c(paste("pval", 
                                   colnames(y1_pvals_tech)[1:21], 
                                   sep = "_"), 
                             paste("coeff", 
                                   colnames(y1_pvals_tech)[22:42], 
                                   sep = "_"),
                             colnames(y1_pvals_tech)[43:75])
...
ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=12),
        axis.title = element_blank()) +
  ggsave(filename="2021-03-28_CHILD_y1_cg05732646_KBTBD6.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
    ylim(0.5, 0.9) +
  ggsave(filename="2021-03-28_CHILD_y1_cg22908922_PACS2.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3, height = 2.1, units = "in")
...
ggplot(y1_cg12228123_res, aes(x=xresid, y=yresid)) +
  ...
  ylim(-0.2, 0.2) +
  xlim(-16.5, 16) +
  ggsave(filename="2021-03-28_CHILD_y1_AFAP1.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
    ylim(0.5, 0.99) +
  ggsave(filename="2021-03-28_CHILD_y1_cg12228123_AFAP1.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3, height = 2.1, units = "in")
...
write.csv(goi_df_pval[1:50,], file=here("figures", "linear_regression", "prenatal",
                                 "2021-03-128_goi.csv"))
