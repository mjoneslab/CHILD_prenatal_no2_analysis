...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
  ggsave(filename="2021-03-23_CHILD_cb_cg05732646_KBTBD6_poster.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 12, height = 8.15, units = "cm")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
  ylim(0.5, 0.9) +
  ggsave(filename="2021-03-23_CHILD_cb_cb_cg22908922_PACS2_poster.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 12, height = 8.15, units = "cm")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
     ylim(0.5, 0.99) +
  ggsave(filename="2021-03-23_CHILD_cb_cg12228123_AFAP1_poster.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 12, height = 8.15, units = "cm")
...
ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=18),
        axis.title = element_blank()) +
  ggsave(filename="2021-03-23_CHILD_y1_cg05732646_KBTBD6_poster.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 12, height = 8.15, units = "cm")
...
ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
    ylim(0.5, 0.9) +
  ggsave(filename="2021-03-23_CHILD_y1_cg22908922_PACS2_poster.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 12, height = 8.15, units = "cm")
...
#  ggtitle("cg12228123") +
  ...
  ylim(-0.2, 0.2) +
  xlim(-16.5, 14) +
  ggsave( filename="2021-03-17_CHILD_y1_cg12228123_AFAP.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 3, height = 2.1, units = "in")
...
ggplot(y1_cg12228123_res, aes(x=xresid, y=yresid)) +
  ...
  ylim(-0.2, 0.2) +
  xlim(-16.5, 16) +
  ggsave(filename="2021-03-17_CHILD_y1_AFAP1_poster.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 12, height = 8.15, units = "cm")
...
ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
    ylim(0.5, 0.99) +
  ggsave(filename="2021-03-23_CHILD_y1_cg12228123_AFAP1_poster.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 12, height = 8.15, units = "cm")
...
covariates_geno_ctpc_tech_cc$cg24172570 <- 
  cb_betas_geno_cc_clean[rownames(cb_betas_geno_cc_clean)=="cg24172570", ] 

cg24172570_lm <- lm(cg24172570 ~ 
                      no2_preg_entire + sex + gestational_days + pss_18wk + 
                      prenatal_maternal_smoking + maternal_education_length + 
                      cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4 + cbmc.PC5 + 
                      genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
#  ggtitle("cg12228123") +
  ...
  ggsave( filename="2021-03-17_CHILD_cg24172570_HIBADH.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 3.1,
          height = 2.6,
          units = "in")
