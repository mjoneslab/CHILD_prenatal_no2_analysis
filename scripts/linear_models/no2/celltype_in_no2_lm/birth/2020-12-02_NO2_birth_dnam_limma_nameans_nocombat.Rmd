...
test2 <- 
  as.vector(cb_pvals_tech$pval_no2_preg_entire)

test2df <- as.data.frame(test2)

ggplot(test2df, aes(test2)) + geom_histogram(binwidth = 0.001) + xlim(-0.15, 0.15)
...
write.csv(lmstats_wide, file=here("output_data", "linear_regression", "2020-12-02_deltabeta_noeducation.csv"))
