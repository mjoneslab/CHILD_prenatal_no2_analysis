...
Load betas
```{r load_betas}
load(file=here("output_data", "celltype_corrected_betas", "2020-12-21_CHILD_birth_betas_celltype_6PCs_corrected.Rdata"))
...
adj_cb_mvals <- lumi::beta2m(adj_cb_6pcs_betas_geno_cc)
