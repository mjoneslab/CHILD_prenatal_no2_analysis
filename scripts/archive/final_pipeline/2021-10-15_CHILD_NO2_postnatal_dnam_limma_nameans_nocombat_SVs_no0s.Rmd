...
library(bacon) # bacon pvalue correction
```
...
mod0 <- model.matrix(~ sex + maternal_smoking_y1 + maternal_education_length +
                       pss_6mos + genotyping.PC1 + genotyping.PC2 + 
                       genotyping.PC3 + 
                       celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                       celltype.PC4 + celltype.PC5 + celltype.PC6 + celltype.PC7, 
                     data=covariates_geno_ctpcs_tech_cc_not0)
...
save(sv_y1, file = here("output_data", "linear_regression", "2021-10-21_postnatal_svs.RData"))
...
ggsave(plot = pn_sv_scree, 
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal", 
                       "2021-10-15_pn_sv_heat_scree.png"),
...
ggsave(plot = svcorr,
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal",
                       "2021-11-01_pn_sv_correlations.png"),
       height = 15,
       width = 15, 
       units = "cm")
...
ggsave(plot = bacon_before_after, 
       filename= here("figures", 
                      "linear_regression", 
                      "postnatal", 
                      "2021-10-25_pn_bacon_before_after.png"),
...
qqplot <- ggplot(pval_qq, aes(x=e, y=o)) + 
  ...
  annotate("text", x=4, y=1.5, 
           label = paste("Inflation = ", round(inflation, 2), 
                         "\nBias = ", round(bias, 2)), 
           size=4, hjust=0) +
  theme_bw() +
...
#volcano plot
volcano_plot <- ggplot(diff_pvals_tech, aes(x=as.numeric(db)*100 , y=-log10(as.numeric(pval_no2_y1_entire_bacon)))) +
...
write.csv(limma::topTable(diff_ebayes_sig, number=10, 
          ...
          here("tables", "yearone", "2021-10-24_toptable_yearone_10cpgs.csv"))
...
summary(cg07472943_res_fit)

# plot
cg07472943_PR <- ggplot(cg07472943_res, aes(x=xresid, y=yresid*100)) + 
...
ggsave(plot = cg07472943_PR,
       filename = here("figures", 
                       "linear_regression",
                       "postnatal",
                       "2021-10-25_cg07472943_SHC2_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg07472943_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
...
ggsave(plot = cg07472943_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal", 
                       "2021-10-25_cg07472943_SHC2_raw.png"),
...
# get partial residuals for no2 and dnam 
cg19263548_res <- partialResid(cg19263548 ~ no2_y1_entire, 
                               cg19263548_lm,
                               data=covariates_geno_ctpcs_tech_cc_not0)

# fit again to get r2
cg19263548_res_fit <- lm(cg19263548_res$yresid ~ cg19263548_res$xresid)

# summary of partial residual fit
summary(cg19263548_res_fit)

# plot
cg19263548_PR <- ggplot(cg19263548_res, aes(x=xresid, y=yresid*100)) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = cg19263548_PR,
       filename = here("figures", 
                       "linear_regression",
                       "postnatal",
                       "2021-10-25_cg19263548_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg19263548_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
...
ggsave(plot = cg19263548_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal", 
                       "2021-10-25_cg19263548_raw.png"),
       width = 3.7, height = 3.2, units = "cm")
...
# get partial residuals for no2 and dnam 
cg26989646_res <- partialResid(cg26989646 ~ no2_y1_entire, 
                               cg26989646_lm,
                               data=covariates_geno_ctpcs_tech_cc_not0)

# fit again to get r2
cg26989646_res_fit <- lm(cg26989646_res$yresid ~ cg26989646_res$xresid)

# summary of partial residual fit
summary(cg26989646_res_fit)

# plot
cg26989646_PR <- ggplot(cg26989646_res, aes(x=xresid, y=yresid*100)) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = cg26989646_PR,
       filename = here("figures", 
                       "linear_regression",
                       "postnatal",
                       "2021-10-25_cg26989646_FOSL2_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg26989646_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
...
ggsave(plot = cg26989646_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal", 
                       "2021-10-25_cg26989646_FOSL2_raw.png"),
       width = 3.7, height = 3.2, units = "cm")
...
# get partial residuals for no2 and dnam 
cg04823720_res <- partialResid(cg04823720 ~ no2_y1_entire, 
                               cg04823720_lm,
                               data=covariates_geno_ctpcs_tech_cc_not0)

# fit again to get r2
cg04823720_res_fit <- lm(cg04823720_res$yresid ~ cg04823720_res$xresid)

# summary of partial residual fit
summary(cg04823720_res_fit)

# plot
cg04823720_PR <- ggplot(cg04823720_res, aes(x=xresid, y=yresid*100)) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = cg04823720_PR,
       filename = here("figures", 
                       "linear_regression",
                       "postnatal",
                       "2021-10-25_cg04823720_SLC25A13_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg04823720_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
...
ggsave(plot = cg04823720_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal", 
                       "2021-10-25_cg04823720_SLC25A13_raw.png"),
       width = 3.7, height = 3.2, units = "cm")
...
# get partial residuals for no2 and dnam 
cg15212210_res <- partialResid(cg15212210 ~ no2_y1_entire, 
                               cg15212210_lm,
                               data=covariates_geno_ctpcs_tech_cc_not0)

# fit again to get r2
cg15212210_res_fit <- lm(cg15212210_res$yresid ~ cg15212210_res$xresid)

# summary of partial residual fit
summary(cg15212210_res_fit)

# plot
cg15212210_PR <- ggplot(cg15212210_res, aes(x=xresid, y=yresid*100)) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = cg15212210_PR,
       filename = here("figures", 
                       "linear_regression",
                       "postnatal",
                       "2021-10-25_cg15212210_C2CD2L_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg15212210_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
...
ggsave(plot = cg15212210_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal", 
                       "2021-10-25_cg15212210_C2CD2L_raw.png"),
       width = 3.7, height = 3.2, units = "cm")
...
# get partial residuals for no2 and dnam 
cg08906030_res <- partialResid(cg08906030 ~ no2_y1_entire, 
                               cg08906030_lm,
                               data=covariates_geno_ctpcs_tech_cc_not0)

# fit again to get r2
cg08906030_res_fit <- lm(cg08906030_res$yresid ~ cg08906030_res$xresid)

# summary of partial residual fit
summary(cg08906030_res_fit)

# plot
cg08906030_PR <- ggplot(cg08906030_res, aes(x=xresid, y=yresid*100)) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = cg08906030_PR,
       filename = here("figures", 
                       "linear_regression",
                       "postnatal",
                       "2021-10-25_cg08906030_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg08906030_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
...
ggsave(plot = cg08906030_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal", 
                       "2021-10-25_cg08906030_raw.png"),
       width = 3.7, height = 3.2, units = "cm")
...
# summary of partial residual fit
summary(cg24353392_res_fit)

# plot
cg24353392_PR <- ggplot(cg24353392_res, aes(x=xresid, y=yresid*100)) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = cg24353392_PR,
       filename = here("figures", 
                       "linear_regression",
                       "postnatal",
                       "2021-10-25_cg24353392_CRHR1_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg24353392_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
...
ggsave(plot = cg24353392_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal", 
                       "2021-10-25_cg24353392_CRHR1_raw.png"),
       width = 3.7, height = 3.2, units = "cm")
...
# get partial residuals for no2 and dnam 
cg06655349_res <- partialResid(cg06655349 ~ no2_y1_entire, 
                               cg06655349_lm,
                               data=covariates_geno_ctpcs_tech_cc_not0)

# fit again to get r2
cg06655349_res_fit <- lm(cg06655349_res$yresid ~ cg06655349_res$xresid)

# summary of partial residual fit
summary(cg06655349_res_fit)

# plot
cg06655349_PR <- ggplot(cg06655349_res, aes(x=xresid, y=yresid*100)) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = cg06655349_PR,
       filename = here("figures", 
                       "linear_regression",
                       "postnatal",
                       "2021-10-25_cg06655349_S1PR2_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg06655349_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
...
ggsave(plot = cg06655349_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal", 
                       "2021-10-25_cg06655349_S1PR2_raw.png"),
       width = 3.7, height = 3.2, units = "cm")
...
goi <- annotation[grep("^RNF39|^CYP2E1|^LONP1|^SLC25A28|^PLVAP|^CAT$|^CAT;|^TPO|^NFKB1|^NOX2|^SOD1|^TRX1|^TRX2|^GSTP1|^MT3|^NQO1|^HMOX1|^TGPX1|^DDH1|^NOS2|^CYP2C11|^CYP7B|^ALOX12$|^ALOX5;|^ALOX5$|^NRF2$|^NRF2;|^KEAP1|^AHR$|^AHR;|^ARNT;|^ARNT$|^GCLC|^GCLM|^GSR1|^SLC7A11|^GPC2|^GSTA1|^GSTA2|^GSTA3|^GSTA5|^GSTM1|^GSTM2|^GSTM3|^TXN$|^TXN;|^TXNRD1$|^TXNRD1;|^SRXN1|^G6PD|^CYP1A1|^IL1A|^IL2$|^IL2;|^IL3$|^IL3;|^IL4;|^IL4$|^IL5$|^IL5;|^IL6$|^IL6;|^IL9$|^IL9;|^IL10$|^IL10;|^IL12A|^IL13|^IL15$|^IL15;|^IL17A|^IL18$|^IL18;|^IL19|^IL21$|^IL21;|^IL22$|^IL22;|^IL23A$|^IL23A;|^IL25$|^IL25;|^IL27$|^IL27;|^IL31$|^IL31;|^IL33$|^IL33;|^IFNG$|^IFNG;|^TNF$|^TNF;|^TGFB1$|^TGFB1;|^FOXP3|^FTH1", annotation$UCSC_RefGene_Name), ] %>% as.data.frame()
...
write.csv(goi_df_pval_db_sig, 
          here("tables", "yearone", "2022-01-13_toptable_yearone_goi.csv"))
...
cg12283362_PR <-  ggplot(cg12283362_res, aes(x=xresid, y=yresid*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
...
ggsave(plot = cg12283362_PR, 
       filename=here("figures", 
                     "linear_regression", 
                     "postnatal",
                     "2021-10-25_pn_cg12283362_LONP1_PR.png"),
       width = 4.0, height = 3.2, units = "cm")


# normal plot
cb12283362_raw <-  ggplot(covariates_geno_ctpcs_tech_cc_not0,
                          aes(x=no2_y1_entire, y=cg12283362*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
...
ggsave(plot = cb12283362_raw, 
       filename=here("figures", 
                     "linear_regression", 
                     "postnatal",
                     "2021-10-25_pn_cg12283362_LONP1_raw.png"),
       width = 4.0, height = 3.2, units = "cm")
...
# partial residual plot
cg08973675_PR <- ggplot(cg08973675_res, aes(x=xresid, y=yresid*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  scale_y_continuous(limits=c(-10, 10)) + 
  theme_bw() +
...
ggsave(plot = cg08973675_PR, 
       filename=here("figures", 
                     "linear_regression", 
                     "postnatal",
                     "2021-10-25_pn_cg08973675_SLC25A28_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg08973675_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
                         aes(x=no2_y1_entire,y=cg08973675*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  scale_y_continuous(limits = c(-15, 15), breaks = seq(-15, 15, by = 5)) +
  theme_bw() +
...
ggsave(plot = cg08973675_raw, 
       filename=here("figures", 
                     "linear_regression", 
                     "postnatal",
                     "2021-10-25_pn_cg08973675_SLC25A28_raw.png"),
       width = 4.0, height = 3.2, units = "cm")
...
# plot it
cg18668679_PR <- ggplot(cg18668679_res, aes(x=xresid, y=yresid*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  scale_y_continuous(limits=c(-10, 10)) + 
  theme_bw() +
...
ggsave(plot = cg18668679_PR, 
       filename=here("figures", 
                     "linear_regression", 
                     "postnatal",
                     "2021-10-25_pn_cg18668679_LONP1_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cg18668679_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
                         aes(x=no2_y1_entire, y=cg18668679*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  scale_y_continuous(limits = c(-15, 15), breaks = seq(-15, 15, by = 5)) +
  theme_bw() +
...
ggsave(plot = cg18668679_raw, 
       filename=here("figures", 
                     "linear_regression", 
                     "postnatal",
                     "2021-10-25_pn_cg18668679_LONP1_raw.png"),
       width = 4.0, height = 3.2, units = "cm")
...
ggplot(covariates_geno_ctpcs_tech_cc_not0 %>% 
         select(any_wheeze_y1, cg07472943) %>%
         na.omit(), 
       aes(x=as.factor(any_wheeze_y1), y=cg07472943)) +
  geom_boxplot() +
...
cg07472943_wheeze_log <- glm(any_wheeze_y1 ~ cg07472943 +
                                 sex + pss_6mos +
                                 maternal_smoking_y1 + maternal_education_length +
                                 celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                                 celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
cg07472943_atopy_log <- glm(clinician_atopy_dx_y1 ~ cg07472943 +
                                 sex + pss_6mos +
                                 maternal_smoking_y1 + maternal_education_length +
                                 celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                                 celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# wheeze logistic model 
cg19263548_wheeze_log <- glm(any_wheeze_y1 ~ cg19263548 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# reported atopy
ggplot(covariates_geno_ctpcs_tech_cc_not0 %>% 
         select(clinician_atopy_dx_y1, cg19263548) %>%
         na.omit(), 
...
# wheeze logistic
cg26989646_wheeze_log <- glm(any_wheeze_y1 ~ cg26989646 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# atopy logistic
cg26989646_atopy_log <- glm(clinician_atopy_dx_y1 ~ cg26989646 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
cg26989646_atopy_log_tidy # dnam pvalue = 0.0611
...
# wheeze logistic
cg04823720_wheeze_log <- glm(any_wheeze_y1 ~ cg04823720 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# atopy logistic
cg04823720_atopy_log <- glm(clinician_atopy_dx_y1 ~ cg04823720 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# wheeze logistic
cg15212210_wheeze_log <- glm(any_wheeze_y1 ~ cg15212210 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# atopy logistic
cg15212210_atopy_log <- glm(clinician_atopy_dx_y1 ~ cg15212210 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# wheeze logistic 
cg08906030_wheeze_log <- glm(any_wheeze_y1 ~ cg08906030 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# atopy logistic 
cg08906030_atopy_log <- glm(clinician_atopy_dx_y1 ~ cg08906030 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# wheeze logistic 
cg24353392_wheeze_log <- glm(any_wheeze_y1 ~ cg24353392 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
cg24353392_wheeze_log_tidy # dnam pvalue = 0.0869 
...
# atopy logistic 
cg24353392_atopy_log <- glm(clinician_atopy_dx_y1 ~ cg24353392 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# wheeze logistic 
cg06655349_wheeze_log <- glm(any_wheeze_y1 ~ cg06655349 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
# atopy logistic 
cg06655349_atopy_log <- glm(clinician_atopy_dx_y1 ~ cg06655349 +
                           sex + pss_6mos +
                           maternal_smoking_y1 + maternal_education_length +
                           celltype.PC1 + celltype.PC2 + celltype.PC3 + 
                           celltype.PC4 + celltype.PC5 + celltype.PC6 + 
...
methmean_PR <- ggplot(methmean_res, aes(x=xresid, y=yresid*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") +
...
ggsave(plot = methmean_PR,
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal",
                       "2021-10-24_pn_global_dnam_PR.png"),
       width = 4.2, height = 3.2, units = "cm")

# normal plot
methmean_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
                       aes(x=no2_y1_entire, 
                           y=methmeans*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
...
ggsave(plot = methmean_raw,
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal",
                       "2021-10-24_pn_global_dnam_raw.png"),
       width = 4.2, height = 3.2, units = "cm")
...
covariates_geno_ctpcs_tech_cc_not0$linemeth <- linemeth
...
# partial residual plot
linemeth_PR <- ggplot(linemeth_res, aes(x=xresid, y=yresid*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") +
  scale_y_continuous(limits = c(-1, 1)) + 
  theme_bw() +
...
ggsave(plot = linemeth_PR,
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal",
                       "2021-10-24_pn_line_dnam_PR.png"),
       width = 4.2, height = 3.2, units = "cm")

# normal plot
linemeth_raw <- ggplot(covariates_geno_ctpcs_tech_cc_not0,
                       aes(x=no2_y1_entire,y=linemeth*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  scale_y_continuous(limits = c(-4, 6), breaks = seq(-4, 6, by = 2)) +
  theme_bw() +
...
ggsave(plot = linemeth_raw,
       filename = here("figures", 
                       "linear_regression", 
                       "postnatal",
                       "2021-10-24_pn_line_dnam_raw.png"),
       width = 4.2, height = 3.2, units = "cm")

# correlation 
cor(covariates_geno_ctpcs_tech_cc_not0$linemeth, 
    covariates_geno_ctpcs_tech_cc_not0$no2_y1_entire,
    method="pearson") # -0.05782799
```
...
# linear regression
cg07472943_bm_lm <- lm(cg07472943 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# linear regression
cg07472943_nobm_lm <- lm(cg07472943 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
anova(cg07472943_bm_lm, cg07472943_nobm_lm) # p = 0.703
summary(cg07472943_bm_lm) # birth months are ns
...
ggsave(plot = cg07472943_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg0747294_SHC2_birthmonth.png"),
...
# linear regression
cg19263548_bm_lm <- lm(cg19263548 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
cg19263548_nobm_lm <- lm(cg19263548 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# anova to assess significance of interaction term
anova(cg19263548_bm_lm, cg19263548_nobm_lm) # p = 0.968
summary(cg19263548_bm_lm) # birth months are ns 
...
ggsave(plot = cg19263548_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg19263548_birthmonth.png"),
       width = 4.8, height = 4, units = "cm")
...
# linear regression
cg26989646_bm_lm <- lm(cg26989646 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
cg26989646_nobm_lm <- lm(cg26989646 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# anova to assess significance of interaction term
anova(cg26989646_bm_lm, cg26989646_nobm_lm) # p = 0.9446
summary(cg26989646_bm_lm) # march trending 0.09
...
ggsave(plot = cg26989646_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg26989646_FOSL2_birthmonth.png"),
       width = 4.8, height = 4, units = "cm")
...
# linear regression
cg04823720_bm_lm <- lm(cg04823720 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
cg04823720_nobm_lm <- lm(cg04823720 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# anova to assess significance of interaction term
anova(cg04823720_bm_lm, cg04823720_nobm_lm) # p = 0.03984
summary(cg04823720_bm_lm) # october trending at 0.07
...
ggsave(plot = cg04823720_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg04823720_SLC25A13_birthmonth.png"),
       width = 4.8, height = 4, units = "cm")
...
# linear regression
cg15212210_bm_lm <- lm(cg15212210 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# linear regression
cg15212210_nobm_lm <- lm(cg15212210 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# anova to assess significance of interaction term
anova(cg15212210_bm_lm, cg15212210_nobm_lm) # p = 0.6817
summary(cg15212210_bm_lm) # birth months are ns
...
ggsave(plot = cg15212210_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg15212210_C2CD2L_birthmonth.png"),
       width = 4.8, height = 4, units = "cm")
...
# linear regression
cg08906030_bm_lm <- lm(cg08906030 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
cg08906030_nobm_lm <- lm(cg08906030 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# anova to assess significance of interaction term
anova(cg08906030_bm_lm, cg08906030_nobm_lm) # p = 0.7876
summary(cg08906030_bm_lm) # birth months are ns
...
ggsave(plot = cg08906030_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg08906030_birthmonth.png"),
       width = 4.8, height = 4, units = "cm")
...
# linear regression
cg24353392_bm_lm <- lm(cg24353392 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
cg24353392_nobm_lm <- lm(cg24353392 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# anova to assess significance of interaction term
anova(cg24353392_bm_lm, cg24353392_nobm_lm) # p = 0.6332
summary(cg24353392_bm_lm) # birth months are ns
...
ggsave(plot = cg24353392_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg24353392_CRHR1_birthmonth.png"),
       width = 4.8, height = 4, units = "cm")
...
# linear regression
cg06655349_bm_lm <- lm(cg06655349 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# linear regression
cg06655349_nobm_lm <- lm(cg06655349 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# anova to assess significance of interaction term
anova(cg06655349_bm_lm, cg06655349_nobm_lm) # p = 0.8683
summary(cg06655349_bm_lm) # birth months are ns
...
ggsave(plot = cg06655349_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg06655349_S1PR2_birthmonth.png"),
       width = 4.8, height = 4, units = "cm")
...
# linear regression
cg18792689_bm_lm <- lm(cg18792689 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# linear regression
cg18792689_nobm_lm <- lm(cg18792689 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# anova to assess significance of interaction term
anova(cg18792689_bm_lm, cg18792689_nobm_lm) # p = 0.6066
summary(cg18792689_bm_lm) # june trending 0.06
...
ggsave(plot = cg18792689_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg18792689_FNDC7_birthmonth.png"),
       width = 4.8, height = 4, units = "cm")
...
# linear regression
cg25530908_bm_lm <- lm(cg25530908 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
cg25530908_nobm_lm <- lm(cg25530908 ~  no2_y1_entire + sex + pss_6mos + 
                      maternal_smoking_y1 + maternal_education_length +
                      celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                      celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                      celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# anova to assess significance of interaction term
test <- anova(cg25530908_bm_lm, cg25530908_nobm_lm) # p = 0.1233
summary(cg25530908_bm_lm) # march, april, may, sept, dec are sig 
...
ggsave(plot = cg25530908_bm,
       filename =  here("figures", 
                        "linear_regression",
                        "postnatal",
                        "2021-10-24_pn_cg25530908_birthmonth.png"),
       width = 4.8, height = 4, units = "cm")
