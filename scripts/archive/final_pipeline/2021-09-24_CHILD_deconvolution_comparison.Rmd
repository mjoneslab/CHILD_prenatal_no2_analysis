...
child_fsbepic_ecc2_y1_both <-estimateCellCounts2(y1_rgset, 
...
child_fsbepic_ecc2_y1_idol <-estimateCellCounts2(y1_rgset, 
                            compositeCellType = "Blood",
                            probeSelect = "IDOL",
                            processMethod = "preprocessNoob",
                            cellTypes = c("NK","Bcell","CD4T","CD8T","Mono"), 
...
child_fsbepic_ecc2_y1_any <-estimateCellCounts2(y1_rgset, 
                            compositeCellType = "Blood",
                            probeSelect = "any",
                            processMethod = "preprocessNoob",
                            cellTypes = c("NK","Bcell","CD4T","CD8T","Mono"), 
...
save(child_fscbc_ecc2_cb_any,
     ...
     file=here("output_data", "deconvolution", "2021-09-24_CHILD_deconvolution_method_comparison.Rdata"))
```
