...
Load covariate data
```{r covariates}
load(here::here("output_data", "covariates", "2021-09-24_CHILD_all_covariates.Rdata"))
```
...
save mean data set
```{r save}
save(covariates_nameans, file=here::here("output_data","covariates", "2021-09-24_CHILD_covariates_na_with_means.Rdata"))
```