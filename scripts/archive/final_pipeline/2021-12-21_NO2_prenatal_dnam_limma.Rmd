...
library(ggeffects) # for getting marginal effects
...
# save 
save(sv_cb, file = here("output_data", "linear_regression", "2021-09-24_prenatal_svs.RData"))
...
ggsave(plot = cb_sv_scree, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal", 
                       "2021-10-15_cb_sv_heat_scree.png"),
...
ggsave(plot = svcorr,
       filename = here("figures",
                       "linear_regression",
                       "prenatal", 
                       "2021-10-15_cb_sv_correlations.png"),
...
ggsave(plot = bacon_before_after, 
       filename= here("figures", 
                      "linear_regression", 
                      "prenatal", 
                      "2021-10-15_cb_bacon_before_after.png"),
...
qqplot <- ggplot(pval_qq, aes(x=e, y=o)) + 
  ...
  geom_abline(slope = 1, intercept = 0, 
              col = "black", size=0.25, linetype="solid") +
...
write.csv(limma::topTable(cb_ebayes_sig, number=20, 
          ...
          here("tables", "prenatal", "2022-01-13_toptable_prenatal_10cpgs.csv"))
...
cb_cg27481559_res <- partialResid(cb_cg27481559 ~ no2_preg_entire, 
                                  cb_cg27481559_lm,
                                  data=covariates_geno_ctpc_tech_cc)

# fit again to get r2
cb_cg27481559_res_fit <- lm(cb_cg27481559_res$yresid ~ cb_cg27481559_res$xresid)

# summary of partial residual fit
summary(cb_cg27481559_res_fit)

# marginal effects
library(ggeffects)

test <- ggpredict(model = cb_cg27481559_lm, 
                  terms = "no2_preg_entire")

ggplot(covariates_geno_ctpc_tech_cc,
       aes(x=no2_preg_entire, y=cb_cg27481559*100)) + 
    stat_smooth(method="lm", se=F, col="black", size=0.5, linetype="dashed") + 
    geom_point(alpha=0.6, col = "#254A90", size=1) +
    geom_line(data = test, aes(x=x, y = predicted*100), color = "red", linetype = "dashed") +
    geom_ribbon(data = test %>% 
                  rename("cb_cg27481559" = predicted), 
                aes(ymin = conf.low*100, ymax = conf.high*100, x = x), 
                color = NA, alpha = 0.2) +
    theme_bw() +
    theme(panel.grid = element_blank(),
...
# plot
cb_cg27481559_PR <- ggplot(cb_cg27481559_res, aes(x=xresid, y=yresid*100)) + 
...
ggsave(plot = cb_cg27481559_PR,
       filename = here("figures", 
                       "linear_regression",
                       "prenatal",
                       "2022-01-13_cb_cg27481559_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cb_cg27481559_raw <- ggplot(covariates_geno_ctpc_tech_cc,
                            aes(x=no2_preg_entire, y=cb_cg27481559*100)) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  ylim(15, 45) +
...
ggsave(plot = cb_cg27481559_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal", 
                       "2022-01-13_cb_cg27481559.png"),
...
test2 <- ggpredict(model = cb_cg12228123_lm, 
                  terms = "no2_preg_entire")

ggplot(covariates_geno_ctpc_tech_cc,
       aes(x=no2_preg_entire, y=cb_cg12228123*100)) + 
    stat_smooth(method="lm", se=F, col="black", size=0.5, linetype="dashed") + 
    geom_point(alpha=0.6, col = "#254A90", size=1) +
    geom_line(data = test, aes(x=x, y = predicted*100), color = "red", linetype = "dashed") +
    geom_ribbon(data = test %>% 
...
cb_cg12228123_PR <- ggplot(cb_cg12228123_res, aes(x=xresid, y=yresid*100)) +
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = cb_cg12228123_PR, 
       filename=here("figures", 
                     "linear_regression", 
                     "prenatal",
                     "2022-01-13_cb_cg12228123_AFAP1_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
cb_cg12228123_raw <- ggplot(covariates_geno_ctpc_tech_cc,
                            aes(x=no2_preg_entire, 
                                y=cb_cg12228123*100)) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(50, 100), breaks = seq(55, 100, by = 20)) +
  theme_bw() +
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) 

ggsave(plot = cb_cg12228123_raw,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg12228123_AFAP1.png"),
       width = 3.7, height = 3.2, units = "cm")
...
# partial residual plot
global_dnam_PR <- ggplot(methmean_res, aes(x=xresid, y=yresid*100)) +
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") +
...
ggsave(plot = global_dnam_PR,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_global_dnam_PR.png"),
       width = 4.2, height = 3.2, units = "cm")


# normal plot
global_dnam_raw <- ggplot(covariates_geno_ctpc_tech_cc,
...
ggsave(plot = global_dnam_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_global_dnam.png"),
       width = 4.0, height = 3.2, units = "cm")
...
rmsk <- read.delim(file=here("input_data", "repeat_element_anno", "rmsk.txt"), 
                   sep="\t",
                   header = F)
...
#add column to annotation indicating whether probe has at least 15 base pairs in LINE element
...
# partial residual plot
line_dnam_PR <- ggplot(linemeth_res, aes(x=xresid, y=yresid*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  theme_bw() +
  scale_y_continuous(limits=c(-1,1)) + 
...
ggsave(plot = line_dnam_PR, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_line_dnam_PR.png"),
       width = 4.2, height = 3.2, units = "cm")

# normal plot
line_dnam_raw <- ggplot(covariates_geno_ctpc_tech_cc,
...
ggsave(plot = line_dnam_raw,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_line_dnam.png"),
       width = 4.0, height = 3.2, units = "cm")

# correlation 
cor(covariates_geno_ctpc_tech_cc$linemeth, 
    covariates_geno_ctpc_tech_cc$no2_preg_entire,
    method="pearson") # 0.08397297
```
...
write.csv(goi_df_pval_db, file=here("tables", "prenatal",
                                    "2022-01-13_goi_prenatal_cpgs.csv"))
...
write.csv(goi_df_pval_db %>% 
          ...
          here("tables", "prenatal", "2022-01-13_top10goi_prenatal_cpgs.csv"))
...
write.csv(goi_df_pval_db_sig, here("tables", "prenatal", "2022-01-13_toptable_prenatal_goi.csv"))
...
ggsave(plot = cg12283362_PR,
       filename = here("figures",
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg12283362_LONP1_PR.png"),
       width = 4.0, height = 3.2, units = "cm")


# normal plot
cg12283362_raw <- ggplot(covariates_geno_ctpc_tech_cc,
...
ggsave(plot = cg12283362_raw,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg12283362_LONP1.png"),
       width = 4.0, height = 3.2, units = "cm")
...
ggsave(plot = cg08973675_PR, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg08973675_SLC25A28_PR.png"),
       width = 4.0, height = 3.2, units = "cm")


# normal plot
cg08973675_raw <- ggplot(covariates_geno_ctpc_tech_cc,
...
ggsave(plot = cg08973675_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg08973675_SLC25A28.png"),
       width = 4.0, height = 3.2, units = "cm")
...
covariates_geno_ctpc_tech_cc$cg01610636 <- 
  cb_betas_geno_cc_clean[rownames(cb_betas_geno_cc_clean)=="cg01610636", ] 

cg01610636_lm <- lm(cg01610636~ 
                      no2_preg_entire + sex + gestational_days + pss_18wk + 
                      prenatal_maternal_smoking + maternal_education_length + 
                      cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4 + 
                      genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
summary(cg01610636_lm)

# get partial residuals for no2 and dnam 
cg01610636_res <- partialResid(cg01610636 ~ no2_preg_entire, cg01610636_lm, 
                               data=covariates_geno_ctpc_tech_cc)

# fit again to get r2
cg01610636_res_fit <- lm(cg01610636_res$yresid ~ cg01610636_res$xresid)

# partial residual summary
summary(cg01610636_res_fit)

# partial residual plot
cg01610636_PR <- ggplot(cg01610636_res, aes(x=xresid, y=yresid*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") +
  scale_y_continuous(limits=c(-10, 10)) +
  theme_bw() +
...
ggsave(plot = cg01610636_PR, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg01610636_PLVAP_PR.png"),
       width = 4.0, height = 3.2, units = "cm")


# normal plot
cg01610636_raw <- ggplot(covariates_geno_ctpc_tech_cc,
                         aes(x=no2_preg_entire, y=cg01610636*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  #scale_y_continuous(limits = c(0, 20), breaks = seq(0, 20, by = 5)) +
  theme_bw() +
...
ggsave(plot = cg01610636_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg01610636_PLVAP.png"),
       width = 4.0, height = 3.2, units = "cm")

# correlation 
cor(covariates_geno_ctpc_tech_cc$cg01610636, 
    covariates_geno_ctpc_tech_cc$no2_preg_entire,
    method="pearson") # 0.1176034
...
# bacon pvals coded as matrix
# should be numeric
# check for others too
goi_df_pval_db <- goi_df_pval_db %>% 
  mutate_if(is.matrix,as.numeric) 

# subset for rnf39
rnf38dmr <- goi_df_pval_db[grep("^RNF39", goi_df_pval_db$UCSC_RefGene_Name.x), ] %>%
  subset(chr.x == "chr6") %>% 
  subset(pos.x <=  30039801 & pos.x >=30038754) %>%
  arrange(pos.x)

# take cpg in middle of ladd acosta dmr
rnfcpg <- rnf38dmr[18, "Row.names"]
rnfcpg # cg08491487

covariates_geno_ctpc_tech_cc$cg08491487<- 
  cb_betas_geno_cc_clean[rownames(cb_betas_geno_cc_clean)=="cg08491487", ] 

cg08491487_lm <- lm(cg08491487~ 
                      no2_preg_entire + sex + gestational_days + pss_18wk + 
                      prenatal_maternal_smoking + maternal_education_length + 
                      cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4 + 
                      genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
summary(cg08491487_lm)

# get partial residuals for no2 and dnam 
cg08491487_res <- partialResid(cg08491487 ~ no2_preg_entire, cg08491487_lm, 
                               data=covariates_geno_ctpc_tech_cc)

# fit again to get r2
cg08491487_res_fit <- lm(cg08491487_res$yresid ~ cg08491487_res$xresid)

# partial residual summary
summary(cg08491487_res_fit)

# partial residual plot
cg08491487_PR <- ggplot(cg08491487_res, aes(x=xresid, y=yresid*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") +
  #scale_y_continuous(limits=c(-10, 10)) +
  theme_bw() +
...
ggsave(plot = cg08491487_PR, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg08491487_RNF39_PR.png"),
       width = 4.0, height = 3.2, units = "cm")


# normal plot
cg08491487_raw <- ggplot(covariates_geno_ctpc_tech_cc,
                         aes(x=no2_preg_entire, y=cg08491487*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  #scale_y_continuous(limits = c(0, 20), breaks = seq(0, 20, by = 5)) +
  theme_bw() +
...
ggsave(plot = cg08491487_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg08491487_RNF39.png"),
       width = 4.0, height = 3.2, units = "cm")

# correlation 
cor(covariates_geno_ctpc_tech_cc$cg08491487, 
    covariates_geno_ctpc_tech_cc$no2_preg_entire,
    method="pearson") # 0.001820728
...
# subset for cyp2e1
cypdmr <- goi_df_pval_db[grep("^CYP2E1", goi_df_pval_db$UCSC_RefGene_Name.x), ] %>%
  subset(chr.x == "chr10") %>% 
  subset(pos.x <=  135343280 & pos.x >=135341528) %>%
  arrange(pos.x)
 

# take cpg in middle of ladd acosta dmr
cypcpg <- cypdmr[6, "Row.names"]
cypcpg # cg23400446

covariates_geno_ctpc_tech_cc$cg23400446<- 
  cb_betas_geno_cc_clean[rownames(cb_betas_geno_cc_clean)=="cg23400446", ] 

cg23400446_lm <- lm(cg23400446~ 
                      no2_preg_entire + sex + gestational_days + pss_18wk + 
                      prenatal_maternal_smoking + maternal_education_length + 
                      cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4 + 
                      genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
summary(cg23400446_lm)

# get partial residuals for no2 and dnam 
cg23400446_res <- partialResid(cg23400446 ~ no2_preg_entire, cg23400446_lm, 
                               data=covariates_geno_ctpc_tech_cc)

# fit again to get r2
cg23400446_res_fit <- lm(cg23400446_res$yresid ~ cg23400446_res$xresid)

# partial residual summary
summary(cg23400446_res_fit)

# partial residual plot
cg23400446_PR <- ggplot(cg23400446_res, aes(x=xresid, y=yresid*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") +
  #scale_y_continuous(limits=c(-10, 10)) +
  theme_bw() +
...
ggsave(plot = cg23400446_PR, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg23400446_CYP2E1_PR.png"),
       width = 4.0, height = 3.2, units = "cm")


# normal plot
cg23400446_raw <- ggplot(covariates_geno_ctpc_tech_cc,
                         aes(x=no2_preg_entire, y=cg23400446*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  #scale_y_continuous(limits = c(0, 20), breaks = seq(0, 20, by = 5)) +
  theme_bw() +
...
ggsave(plot = cg08491487_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-01-13_cb_cg23400446_CYP2E1.png"),
       width = 4.0, height = 3.2, units = "cm")
...
# reported wheeze
ggplot(covariates_geno_ctpc_tech_cc %>% 
         select(any_wheeze_y1, cb_cg12228123) %>%
         na.omit(), 
...
# clinician atopy
ggplot(covariates_geno_ctpc_tech_cc %>% 
         select(clinician_atopy_dx_y1, cb_cg12228123) %>%
         na.omit(), 
...
# wheeze
ggplot(covariates_geno_ctpc_tech_cc %>% 
         select(any_wheeze_y1, cb_cg27481559) %>%
         na.omit(), 
...
# atopy
ggplot(covariates_geno_ctpc_tech_cc %>% 
         select(clinician_atopy_dx_y1, cb_cg27481559) %>%
         na.omit(), 
...
ggsave(filename="2021-10-26_CHILD_cb_cg12228123_AFAP1_bm.png",
...
ggsave(filename="2021-10-26_CHILD_cb_cg27481559_bm.png",
       path =  here("figures", "linear_regression", "prenatal"),
       width = 4.8, height = 4, units = "cm")
...
ggsave(filename="2021-10-26_CHILD_cb_cg22230559_BAT1_bm.png",
       path =  here("figures", "linear_regression", "prenatal"),
       width = 4.8, height = 4, units = "cm")
...
ggsave(filename="2021-10-26_CHILD_cb_cg05231970_bm.png",
       path =  here("figures", "linear_regression", "prenatal"),
       width = 4.8, height = 4, units = "cm")
...
ggsave(filename="2021-10-26_CHILD_cb_cg26787539_CDT1_bm.png",
       path =  here("figures", "linear_regression", "prenatal"),
       width = 4.8, height = 4, units = "cm")
...
ggsave(filename="2021-10-26_CHILD_cb_cg08568767_bm.png",
       path =  here("figures", "linear_regression", "prenatal"),
       width = 4.8, height = 4, units = "cm")
...
ggsave(filename="2021-10-26_CHILD_cb_cg02386875_LRRC37B2_bm.png",
       path =  here("figures", "linear_regression", "prenatal"),
       width = 4.8, height = 4, units = "cm")
...
ggsave(filename="2021-10-26_CHILD_cb_cg04256907_ZMIZ1_bm.png",
       path =  here("figures", "linear_regression", "prenatal"),
       width = 4.8, height = 4, units = "cm")
...
ggsave(filename="2021-10-26_CHILD_cb_cg10920410_GMPS_bm.png",
       path =  here("figures", "linear_regression", "prenatal"),
       width = 4.8, height = 4, units = "cm")
...
ggsave(filename="2021-10-26_CHILD_cb_cg03392571_C21orf70_bm.png",
       path =  here("figures", "linear_regression", "prenatal"),
       width = 4.8, height = 4, units = "cm")
```
...
# save 
save(sv_y1, file = here("output_data", "linear_regression", "2021-10-14_ageone_svs.RData"))
...
ggsave(plot = y1_sv_scree, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal", 
                       "2021-10-15_y1_sv_heat_scree.png"),
       height = 5, width = 15, units = "cm")
...
# rename columns with svs
colnames(covariates_geno_ctpc_tech_cc_y1_sub)[169:182] <-
  paste("y1sv",colnames(covariates_geno_ctpc_tech_cc_y1_sub)[169:182], sep="")
...
ggsave(plot = svcorr_y1,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_y1_sv_correlations.png"),
       height = 15,
       width = 15, 
       units = "cm")
...
# get partial residuals for no2 and dnam 
y1_cg27481559_res <- partialResid(y1_cg27481559 ~ no2_preg_entire, 
                                  y1_cg27481559_lm, 
                                  data=covariates_geno_ctpc_tech_cc_y1_sub)

# fit again to get r2
y1_cg27481559_fit <- lm(y1_cg27481559_res$yresid ~ y1_cg27481559_res$xresid)

# summary of partial residual 
summary(y1_cg27481559_fit)

# plots
y1_cg27481559_PR <- ggplot(y1_cg27481559_res, aes(x=xresid, y=yresid*100)) +
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = y1_cg27481559_PR,
       filename = here("figures",
                       "linear_regression", 
                       "prenatal", 
                       "2021-10-15_y1_cg27481559_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
y1_cg27481559_raw <- ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
                            aes(x=no2_preg_entire, y=y1_cg27481559*100)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  theme_bw() +
  ylim(15,45) +
...
ggsave(plot = y1_cg27481559_raw,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_y1_cg27481559.png"),
       width = 3.7, height = 3.2, units = "cm")
...
y1_cg12228123_PR <- ggplot(y1_cg12228123_res, aes(x=xresid, y=yresid*100)) +
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  scale_y_continuous(limits = c(-25, 15), breaks = seq(-20, 10, by = 10)) +
  theme_bw() +
...
ggsave(plot = y1_cg12228123_PR, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_y1_cg12228123_AFAP1_PR.png"),
       width = 4.0, height = 3.2, units = "cm")

# normal plot
y1_cg12228123_raw <- ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
...
ggsave(plot = y1_cg12228123_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_y1_cg12228123_AFAP1.png"),
       width = 3.7, height = 3.2, units = "cm")
...
top100_es_lower <- ggplot(cb100_long %>% 
  ...
  scale_y_continuous(name = "Effect size (% DNA methylation/1 ppb NO2)",
                     limits = c(-25, 10),
                     breaks = seq(-25, 10, 5)) +
  theme_bw() +
...
ggsave(plot = top100_es,
       filename = here("figures",
                       "linear_regression", 
                       "prenatal",
                       "2022-01-06_top100_es_change.png"),
