...
pm2.5 <- read.csv(here("input_data", 
                       "CHILD_pm2.5_data", 
                       "CHILD_PM2.5_data.csv"))
```
...
sapply(covariate_dfs, function(x) {return(identical(as.character(x[,1]), as.character(participants[,1])))}) # ALL TRUE
```
