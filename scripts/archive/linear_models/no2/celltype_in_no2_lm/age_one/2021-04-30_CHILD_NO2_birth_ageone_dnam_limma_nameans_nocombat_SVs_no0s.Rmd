...
ggplot(pval_qq, aes(x=e, y=o)) + 
  ...
  ggsave( filename="2021-05-24_CHILD_y1_qqplot.png",
...
ggplot(diff_pvals_tech, aes(x=as.numeric(db)*100 , y=-log10(as.numeric(pval_no2_y1_entire)))) +
  ...
  #                        (pval_no2_y1_entire < 0.000001 & db > 0.1) | 
  #                          (pval_no2_y1_entire < 0.000001 & db < -0.1)), 
  ...
  # geom_point(data=subset(diff_pvals_tech, 
  #                        (pval_no2_y1_entire < 0.000001 & db > 0.05) | 
  #                          (pval_no2_y1_entire < 0.000001 & db < -0.05)), 
  #            alpha=0.4, col = "red", size=1) + 
  ...
  geom_point(data=subset(diff_pvals_tech, 
                         (pval_no2_y1_entire < 0.000001 & db > 0.025) | 
                           (pval_no2_y1_entire < 0.000001 & db < -0.025)), 
             alpha=0.4, col = "red", size=1) + 
  ...
  ggsave( filename="2021-05-24_CHILD_y1_volcanoplot.png",
          path =  here("figures", "linear_regression", "yearone"),
          width = 7.9, height = 6, units = "cm")
...
ggplot(diff_pvals_tech, aes(x=as.numeric(db)*100 , y=-log10(as.numeric(pval_no2_y1_entire)))) +
  ...
  scale_x_continuous(limits = c(-50, 40), breaks = seq(-50, 40, by = 10)) +
  ...
  ggsave( filename="2021-06-19_CHILD_y1_volcanoplot_poster.png",
          path =  here("figures", "linear_regression", "yearone"),
...
write.csv(topTable(diff_ebayes_sig, number=10, 
     ...
     here("tables", "yearone", "2021-05-24_toptable_yearone_10cpgs.csv"))
...
write.csv(yearone_goi_df_pval_db, file=here("tables", "yearone",
                                 "2021-05-24_goi_postnatal_cpgs.csv"))

# write table of top ten 
write.csv(yearone_goi_df_pval_db %>% 
            subset(db > 0.025 | db < -0.025) %>% 
            subset(-log10(p.value.no2_y1_entire) > 2.1),
          here("tables", "yearone", "2021-05-24_top10goi_yearone_cpgs.csv"))
...
write.csv(goi_df_pval_db_sig, 
          here("tables", "yearone", "2021-05-24_toptable_yearone_goi.csv"))
...
ggplot(cg12283362_res, aes(x=xresid, y=yresid*100)) + 
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg12283362_LONP1_PR.png",
         path =  here("figures", "linear_regression", "yearone"),
...
ggplot(covariates_geno_ctpcs_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-05-24_CHILD_y1_cg12283362_LONP1.png",
         path =  here("figures", "linear_regression", "yearone"),
          width = 4.0, height = 3.2, units = "cm")
...
ggplot(cg08973675_res, aes(x=xresid, y=yresid*100)) + 
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-05-24_CHILD_y1_cg08973675_SLC25A28_PR.png",
         path =  here("figures", "linear_regression", "yearone"),
          width = 4.0, height = 3.2, units = "cm")
...
ggplot(covariates_geno_ctpcs_tech_cc,
 ...
 scale_y_continuous(limits = c(-15, 15), breaks = seq(-15, 15, by = 5)) +
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-05-24_CHILD_y1_cg08973675_SLC25A28.png",
         path =  here("figures", "linear_regression", "yearone"),
          width = 4.0, height = 3.2, units = "cm")
...
# plot it
ggplot(cg18668679_res, aes(x=xresid, y=yresid*100)) + 
geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
        scale_y_continuous(limits=c(-10, 10)) + 
  theme_bw() +
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-05-24_CHILD_y1_cg18668679_LONP1_PR.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.0, height = 3.2, units = "cm")
...
ggplot(covariates_geno_ctpcs_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-05-24_CHILD_y1_cg18668679_LONP1.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.0, height = 3.2, units = "cm")
...
ggplot(methmean_res, aes(x=xresid, y=yresid*100)) + 
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-05-24_CHILD_y1_global_dnam_PR.png",
         path =  here("figures", "linear_regression", "yearone"),
...
ggplot(covariates_geno_ctpcs_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-05-24_CHILD_y1_global_dnam.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.2, height = 3.2, units = "cm")
...
ggplot(linemeth_res, aes(x=xresid, y=yresid*100)) + 
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-05-24_CHILD_y1_LINE_dnam_PR.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.2, height = 3.2, units = "cm")
...
ggplot(covariates_geno_ctpcs_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-05-24_CHILD_y1_LINE_dnam.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.2, height = 3.2, units = "cm")
...
tidy(cg18668679_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg18668679_LONP1_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
...
# linear regression
cg07472943_bm <- lm(cg07472943 ~  no2_y1_entire + sex + pss_6mos + 
                    maternal_smoking_y1 + maternal_education_length +
                    celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                    celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                    celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
tidy(cg07472943_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  mutate(term = factor(term, levels=c("no2_y1_entire:birth_monthfebruary",
                                      "no2_y1_entire:birth_monthmarch",
                                      "no2_y1_entire:birth_monthapril",
                                      "no2_y1_entire:birth_monthmay",
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg07472943_SHC2_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
          width = 4.8, height = 4, units = "cm")
...
tidy(cg24353392_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg24353392_CRHR1_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.8, height = 4, units = "cm")
...
# add dnam to covariates for linear regression
covariates_geno_ctpcs_tech_cc$cg14148108 <- 
        diff_betas_geno_cc_cpr[rownames(diff_betas_geno_cc_cpr)=="cg14148108", ]

# linear regression
cg14148108_bm <- lm(cg14148108 ~  no2_y1_entire + sex + pss_6mos + 
                    maternal_smoking_y1 + maternal_education_length +
                    celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                    celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                    celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# plot 
tidy(cg14148108_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  mutate(term = factor(term, levels=c("no2_y1_entire:birth_monthfebruary",
                                      "no2_y1_entire:birth_monthmarch",
                                      "no2_y1_entire:birth_monthapril",
                                      "no2_y1_entire:birth_monthmay",
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg14148108_PFKL_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.8, height = 4, units = "cm")
...
covariates_geno_ctpcs_tech_cc$cg19011826 <- 
        diff_betas_geno_cc_cpr[rownames(diff_betas_geno_cc_cpr)=="cg19011826", ]

# linear regression
cg19011826_bm <- lm(cg19011826 ~  no2_y1_entire + sex + pss_6mos + 
                    maternal_smoking_y1 + maternal_education_length +
                    celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                    celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                    celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# plot 
tidy(cg19011826_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  mutate(term = factor(term, levels=c("no2_y1_entire:birth_monthfebruary",
                                      "no2_y1_entire:birth_monthmarch",
                                      "no2_y1_entire:birth_monthapril",
                                      "no2_y1_entire:birth_monthmay",
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg19011826_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.8, height = 4, units = "cm")
...
# linear regression
cg06311934_bm <- lm(cg06311934 ~  no2_y1_entire + sex + pss_6mos + 
                    maternal_smoking_y1 + maternal_education_length +
                    celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                    celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                    celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# plot 
tidy(cg06311934_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  mutate(term = factor(term, levels=c("no2_y1_entire:birth_monthfebruary",
                                      "no2_y1_entire:birth_monthmarch",
                                      "no2_y1_entire:birth_monthapril",
                                      "no2_y1_entire:birth_monthmay",
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg06311934_KCNQ2_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.8, height = 4, units = "cm")
...
# linear regression
cg08906030_bm <- lm(cg08906030 ~  no2_y1_entire + sex + pss_6mos + 
                    maternal_smoking_y1 + maternal_education_length +
                    celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                    celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                    celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# plot 
tidy(cg08906030_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  mutate(term = factor(term, levels=c("no2_y1_entire:birth_monthfebruary",
                                      "no2_y1_entire:birth_monthmarch",
                                      "no2_y1_entire:birth_monthapril",
                                      "no2_y1_entire:birth_monthmay",
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg08906030_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.8, height = 4, units = "cm")
...
# add dnam to covariates for linear regression
covariates_geno_ctpcs_tech_cc$cg27342781 <- 
        diff_betas_geno_cc_cpr[rownames(diff_betas_geno_cc_cpr)=="cg27342781", ]

# linear regression
cg27342781_bm <- lm(cg27342781 ~  no2_y1_entire + sex + pss_6mos + 
                    maternal_smoking_y1 + maternal_education_length +
                    celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                    celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                    celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# plot 
tidy(cg27342781_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  mutate(term = factor(term, levels=c("no2_y1_entire:birth_monthfebruary",
                                      "no2_y1_entire:birth_monthmarch",
                                      "no2_y1_entire:birth_monthapril",
                                      "no2_y1_entire:birth_monthmay",
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg27342781_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.8, height = 4, units = "cm")
...
# add dnam to covariates for linear regression
covariates_geno_ctpcs_tech_cc$cg19356311 <- 
        diff_betas_geno_cc_cpr[rownames(diff_betas_geno_cc_cpr)=="cg19356311", ]

# linear regression
cg19356311_bm <- lm(cg19356311 ~  no2_y1_entire + sex + pss_6mos + 
                    maternal_smoking_y1 + maternal_education_length +
                    celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                    celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                    celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# plot 
tidy(cg19356311_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  mutate(term = factor(term, levels=c("no2_y1_entire:birth_monthfebruary",
                                      "no2_y1_entire:birth_monthmarch",
                                      "no2_y1_entire:birth_monthapril",
                                      "no2_y1_entire:birth_monthmay",
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg19356311_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.8, height = 4, units = "cm")
...
########################
# cg03803541 LOC404266 #
########################

# add dnam to covariates for linear regression
covariates_geno_ctpcs_tech_cc$cg03803541 <- 
        diff_betas_geno_cc_cpr[rownames(diff_betas_geno_cc_cpr)=="cg03803541", ]

# linear regression
cg03803541_bm <- lm(cg03803541 ~  no2_y1_entire + sex + pss_6mos + 
                    maternal_smoking_y1 + maternal_education_length +
                    celltype.PC1 + celltype.PC2 + celltype.PC3 + celltype.PC4 + 
                    celltype.PC5 + celltype.PC6 + celltype.PC7 + celltype.PC8 +
                    celltype.PC9 + genotyping.PC1 + genotyping.PC2 + 
...
# plot 
tidy(cg03803541_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  mutate(term = factor(term, levels=c("no2_y1_entire:birth_monthfebruary",
                                      "no2_y1_entire:birth_monthmarch",
                                      "no2_y1_entire:birth_monthapril",
                                      "no2_y1_entire:birth_monthmay",
  ...
  ggsave(filename="2021-05-24_CHILD_y1_cg038035411_LOC404266_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "yearone"),
         width = 4.8, height = 4, units = "cm")
