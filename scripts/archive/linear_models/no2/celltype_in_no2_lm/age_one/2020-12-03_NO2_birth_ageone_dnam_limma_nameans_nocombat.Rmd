...
```{r mean_meth}
#convert betas to df
betas_diff_geno_cc_df <- as.data.frame(betas_diff_geno_cc)

methmeans <- colMeans(betas_diff_geno_cc_df)
...
#subset betas
betas_diff_geno_cc_lines <- 
  betas_diff_geno_cc[rownames(betas_diff_geno_cc) %in%
                     annotationlines$X, ]

dim(betas_diff_geno_cc_lines)


#convert betas to df
betas_diff_geno_cc_lines_df <- as.data.frame(betas_diff_geno_cc_lines)

linemeth <- colMeans(betas_diff_geno_cc_lines_df)
...
#AHR cpg that is close to sig
covariates_ctpcs_geno_tech_cc$cg26227465 <- betas_diff_geno_cc[rownames(betas_diff_geno_cc)=="cg26227465", ]
...
#PCA
uncor.dat <- t(scale(t(betas_diff_geno_cc)))
