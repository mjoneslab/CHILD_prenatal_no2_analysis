...
covariates_geno_ctpc_tech_cc <- 
  covariates_geno_ctpc_tech[complete.cases(
    covariates_geno_ctpc_tech %>%
...
dim(covariates_geno_ctpc_tech_cc) #101 132
...
# check size
dim(cb_betas_geno_cc_clean) # 424079 101; 565 probes removed
```
...
ggplot(pval_qq, aes(x=e, y=o)) + 
  ...
  ggsave( filename="2021-04-26_CHILD_cb_qqplot.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 8.5, height = 6.5, units = "cm")
```
...
ggplot(cb_pvals_tech, aes(x=as.numeric(db)*100 , y=-log10(as.numeric(pval_no2_preg_entire)))) +
  ...
  ggsave( filename="2021-04-22_CHILD_cb_volcanoplot.png",
          path =  here("figures", "linear_regression", "prenatal"),
...
covariates_geno_ctpc_tech_cc$cb_cg05732646<- 
  cb_betas_geno_cc_clean[rownames(cb_betas_geno_cc_clean)=="cg05732646", ]

# linear regression
cb_cg05732646_lm <- lm(cb_cg05732646 ~ 
...
summary(cb_cg05732646_lm)

# get partial residuals for no2 and dnam 
cb_cg05732646_res <- partialResid(cb_cg05732646 ~ no2_preg_entire, 
                                  cb_cg05732646_lm,
                                  data=covariates_geno_ctpc_tech_cc)

# fit again to get r2
cb_cg05732646_res_fit <- lm(cb_cg05732646_res$yresid ~ cb_cg05732646_res$xresid)

# partial regression plot
ggplot(cb_cg05732646_res, aes(x=xresid, y=yresid)) + 
...
theme(panel.grid.major = element_blank(), 
  ...
  ylim(-0.2, 0.2) +
  xlim(-16.5, 14) + 
  ggsave(filename="2021-03-17_CHILD_cb_cg05732646_KBTBD6.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
  ggsave(filename="2021-04-22_CHILD_cb_cg05732646_KBTBD6.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3.8, height = 3.2, units = "cm")

# correlation 
cor(covariates_geno_ctpc_tech_cc$cb_cg05732646, 
    covariates_geno_ctpc_tech_cc$no2_preg_entire,
    method="pearson") #-0.359306
...
# get partial residuals for no2 and dnam 
cb_cg22908922_res <- partialResid(cb_cg22908922 ~ no2_preg_entire, cb_cg22908922_lm, 
              data=covariates_geno_ctpc_tech_cc)
...
# plot
ggplot(cb_cg22908922_res, aes(x=xresid, y=yresid)) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  theme_bw() +
  #  labs(x=bquote("Prenatal" ~NO[2]~ "(ppb) partial residual"), 
  #       y="Methylation (%) partial residual") +
  #  annotate("text",x=7,y=0.06, label="slope = -0.187", size=4) +
  #  ggtitle("cg22908922") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        axis.text = element_text(size=9),
  ...
  ylim(-0.2, 0.2) +
  xlim(-16.5, 14) +
  ggsave(filename="2021-04-22_CHILD_cb_cg22908922_PACS2.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
  ylim(50, 90) +
  ggsave(filename="2021-04-22_CHILD_cb_cb_cg22908922_PACS2.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3.8, height = 3.2, units = "cm")
...
# plots
ggplot(cb_cg12228123_res, aes(x=xresid, y=yresid)) +
  geom_point(alpha=0.6, col = "#254A90", size=2) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  theme_bw() +
#  labs(x=bquote("Prenatal" ~NO[2]~ "(ppb) partial residual"), 
...
#  ggtitle("cg12228123") +
  ...
  ylim(-0.2, 0.2) +
  xlim(-16.5, 14) +
  ggsave( filename="2021-02-04_CHILD_cb_cg12228123_AFAP1.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  ggsave(filename="2021-04-22_CHILD_cb_cg12228123_AFAP1.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3.8, height = 3.2, units = "cm")
...
# add svs to covariates
covariates_geno_ctpc_tech_cc_y1_sub <- cbind(covariates_geno_ctpc_tech_cc_y1_sub, svobj$sv)
...
# use 9 SVs 
y1_modSv = cbind(y1_mod,svobj_all$v[,1:9])
...
colnames(y1_pvals_tech) <- c(paste("pval", 
                                   colnames(y1_pvals_tech)[1:39], 
                                   sep = "_"), 
                             paste("coeff", 
                                   colnames(y1_pvals_tech)[40:78], 
                                   sep = "_"),
                             colnames(y1_pvals_tech)[79:109])
...
# add dnam to covariates for linear regression
covariates_geno_ctpc_tech_cc_y1_sub$y1_cg05732646<- 
        y1_betas_cc_sub[rownames(y1_betas_cc_sub)=="cg05732646", ]

# linear regression
y1_cg05732646_lm <- lm(y1_cg05732646 ~  
...
# summary of lm
summary(y1_cg05732646_lm)

# get partial residuals for no2 and dnam 
y1_cg05732646_res <- partialResid(y1_cg05732646 ~ no2_preg_entire, 
                                  y1_cg05732646_lm, 
                                  data=covariates_geno_ctpc_tech_cc_y1_sub)

# fit again to get r2
y1_cg05732646_fit <- lm(y1_cg05732646_res$yresid ~ y1_cg05732646_res$xresid)

# plots
ggplot(y1_cg05732646_res, aes(x=xresid, y=yresid)) +
  geom_point(alpha=0.6, col = "#254A90", size=2) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  theme_bw() +
#  labs(x=bquote("Prenatal" ~NO[2]~ "(ppb) partial residual"), 
...
#  ggtitle("cg12228123") +
  ...
  ylim(-0.2, 0.2) +
  xlim(-16.5, 14) +
  ggsave( filename="2021-03-17_CHILD_y1_cg05732646_KBTBD6.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        axis.title = element_blank()) +
  ggsave(filename="2021-04-22_CHILD_y1_cg05732646_KBTBD6.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3.8, height = 3.2, units = "cm")

# correlation 
cor(covariates_geno_ctpc_tech_cc_y1_sub$y1_cg05732646, 
    covariates_geno_ctpc_tech_cc_y1_sub$no2_preg_entire,
    method="pearson") #-0.1129506
...
# plots
ggplot(y1_cg22908922_res, aes(x=xresid, y=yresid)) +
  geom_point(alpha=0.6, col = "#254A90", size=2) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  theme_bw() +
#  labs(x=bquote("Prenatal" ~NO[2]~ "(ppb) partial residual"), 
...
#  ggtitle("cg12228123") +
  ...
  ggsave( filename="2021-03-17_CHILD_y1_cg22908922_PACS2.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
    ylim(50, 90) +
  ggsave(filename="2021-04-22_CHILD_y1_cg22908922_PACS2.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3.8, height = 3.2, units = "cm")
...
# plots
ggplot(y1_cg12228123_res, aes(x=xresid, y=yresid)) +
  geom_point(alpha=0.6, col = "#254A90", size=2) + 
  stat_smooth(method="lm", se=F, col="red", size=0.5, linetype="dashed") + 
  theme_bw() +
#  labs(x=bquote("Prenatal" ~NO[2]~ "(ppb) partial residual"), 
...
#  ggtitle("cg12228123") +
  ...
  ylim(-0.2, 0.2) +
  xlim(-16.5, 14) +
  ggsave( filename="2021-03-28_CHILD_y1_cg12228123_AFAP.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 3, height = 2.1, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc_y1_sub,
  ...
  theme(panel.grid = element_blank(),
    ...
    ylim(50, 99) +
  scale_y_continuous(breaks = seq(55, 95, by = 10)) +
  ggsave(filename="2021-04-22_CHILD_y1_cg12228123_AFAP1.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 3.8, height = 3.2, units = "cm")
...
ggplot(methmean_res, aes(x=xresid, y=yresid)) +
 ...
 #      y= str_wrap("Global DNA methylation (%) partial residual", 30)) +
  ...
  ggsave( filename="2021-03-17_CHILD_cb_global_dnam.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 4.8,
          height = 3.2,
          units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
    ylim(0.48, 0.54) +
  ggsave(filename="2021-03-28_CHILD_cb_global_dnam.png",
         path =  here("figures", "linear_regression", "prenatal"),
...
ggplot(linemeth_res, aes(x=xresid, y=yresid)) + 
 ...
 #      y= str_wrap("Global DNA methylation (%) partial residual", 30)) +
  ...
  ggsave( filename="2021-03-17_CHILD_cb_LINE_dnam.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 4.8,
          height = 3.2,
          units = "in")0
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title = element_blank()) +
    ylim(0.48, 0.54) +
  ggsave(filename="2021-03-28_CHILD_cb_LINE_dnam.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 4.8, height = 3.2, units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=12),
        axis.title = element_blank()) +
  ggsave(filename="2021-03-28_CHILD_cg12283362_LONP1.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 4.8, height = 3.2, units = "in")
...
#  ggtitle("cg12228123") +
  ...
  ggsave( filename="2021-03-17_CHILD_cg08973675_SLC25A28.png",
          path =  here("figures", "linear_regression", "prenatal"),
          width = 3.1,
          height = 2.6,
          units = "in")
...
ggplot(covariates_geno_ctpc_tech_cc,
  ...
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=12),
        axis.title = element_blank()) +
  ggsave(filename="2021-03-28_CHILD_cg08973675_SLC25A28.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 4.8, height = 3.2, units = "in")
...
# linear regression
cb_cg05732646_bm <- lm(cb_cg05732646 ~ 
                         no2_preg_entire + sex + gestational_days + pss_18wk +
                         prenatal_maternal_smoking + maternal_education_length + 
                         cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4 + cbmc.PC5 + 
                         genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
...
anova(cb_cg05732646_bm)


tidy(cb_cg05732646_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>% 
  ...
  ggsave(filename="2021-03-17_CHILD_cb_cg05732646_KBTBD6_birthmonth_aug.png",
         path =  here("figures", "linear_regression", "prenatal"),
...
tidy(cb_cg05732646_bm, conf.int = 0.95) %>% filter(term %>% str_detect(":")) %>%
  mutate(term = factor(term, levels=c("no2_preg_entire:birth_monthfebruary",
                                      ...
                                      "no2_preg_entire:birth_monthnovember",
                                      "no2_preg_entire:birth_monthdecember"))) %>%
  subset(term != "no2_preg_entire:birth_monthaugust") %>%
  ggplot(aes(y = estimate, x = as.factor(term))) + 
  geom_point() +
  geom_errorbar(aes(ymin = conf.low , ymax = conf.high)) +
  theme_bw() +
  #ggtitle("cg15325658") +
  scale_x_discrete(labels=c("NO2:February","NO2:March", "NO2:April", "NO2:May",
                            "NO2:June","NO2:July", "NO2:September",
                            "NO2:October", "NO2:November","NO2:December")) +
  labs(x="Interaction term", y="Estimate") +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
  ...
  ggsave(filename="2021-03-17_CHILD_cb_cg05732646_KBTBD6_birthmonth.png",
         path =  here("figures", "linear_regression", "prenatal"),
         width = 8.8, height = 4.7, units = "in")
...
# linear regression with bm and interaciton term  
cg05732646_fit_bm <- lm(cb_cg05732646 ~ 
                          no2_preg_entire + sex + gestational_days + pss_18wk +
                          prenatal_maternal_smoking + maternal_education_length + 
                          cbmc.PC1 + cbmc.PC2 + cbmc.PC3 + cbmc.PC4 + cbmc.PC5 + 
                          genotyping.PC1 + genotyping.PC2 + genotyping.PC3 + 
