...
ggplot(child_fscbc_fscbcidol_wide, aes(x=FlowSorted.CordBloodCombined.450k.any,
  ...
  ggsave(
    filename="2021-01-20_CHILD_cb_fscbcidol_fscbcany.tiff",
    device = "tiff",
    path =  here("figures", "deconvolution"),
    width = 3,
    height = 2.5,
...
ggplot(child_fscbcboth_fscbcidol_wide, aes(x=FlowSorted.CordBloodCombined.450k.both,
  ...
  ggsave(
    filename="2021-01-20_CHILD_cb_fscbcidol_fscbcboth.tiff",
    device = "tiff",
    path =  here("figures", "deconvolution"),
    width = 3,
    height = 2.5,
...
#convert dataframes to long format for facetting 
child_fscbc_ecc2_y1_any_df_long <- gather(child_fscbc_ecc2_y1_any_df, celltype, percentage, CD4T:CD8T)
child_fscbc_ecc2_y1_idol_df_long <- gather(child_fscbc_ecc2_y1_idol_df, celltype, percentage, CD4T:CD8T)

#row bind two methods together
child_y1_fscbcany_fscbcidol <- rbind(child_fscbc_ecc2_y1_any_df_long, child_fscbc_ecc2_y1_idol_df_long) 

#spread according to method
child_y1_fscbcany_fscbcidol_wide <- spread(child_y1_fscbcany_fscbcidol, method, percentage)
...
#spread according to method
child_y1_fscbcidol_fscbcboth_wide <- spread(child_y1_fscbcidol_fscbcboth, method, percentage )
...
ggplot(child_y1_fscbcidol_fscbcboth_wide, aes(x=FlowSorted.CordBloodCombined.both,
  ...
  ggsave(
    filename="2021-01-20_CHILD_y1_fscbcboth_fscbidol.tiff",
    device = "tiff",
    path =  here("figures", "deconvolution"),
    width = 3,
    height = 2.5,
...
#spread according to method
child_y1_fsbepicboth_fsbepicany_wide <- spread(child_y1_fsbepicboth_fsbepicany, method, percentage)
...
ggplot(child_y1_fsbepicboth_fsbepicany_wide, aes(y=FlowSorted.Blood.EPIC.both,
 ...
 geom_point(aes(col=celltype), size=1) +
  ...
  ggsave(
    filename="2021-01-20_CHILD_y1_fsbepicboth_fsbepicany.tiff",
    device = "tiff",
    path =  here("figures", "deconvolution"),
    width = 3,
    height = 2.5,
...
#convert dataframes to long format for facetting 
child_fsbepic_ecc2_y1_both_df_long <- gather(child_fsbepic_ecc2_y1_both_df, celltype, percentage, NK:Mono)
child_fsbepic_ecc2_y1_idol_df_long <- gather(child_fsbepic_ecc2_y1_idol_df, celltype, percentage, NK:Mono)

#row bind two methods together
child_y1_fsbepicboth_fsbepicidol <- rbind(child_fsbepic_ecc2_y1_both_df_long, child_fsbepic_ecc2_y1_idol_df_long) 

#spread according to method
child_y1_fsbepicboth_fsbepicidol_wide <- spread(child_y1_fsbepicboth_fsbepicidol, method, percentage)
...
#convert dataframes to long format for facetting 
child_fsbepic_ecc2_y1_any_df_long <- gather(child_fsbepic_ecc2_y1_any_df, celltype, percentage, NK:Mono)
child_fsbepic_ecc2_y1_idol_df_long <- gather(child_fsbepic_ecc2_y1_idol_df, celltype, percentage, NK:Mono)

#row bind two methods together
child_y1_fsbepicany_fsbepicidol <- rbind(child_fsbepic_ecc2_y1_any_df_long, child_fsbepic_ecc2_y1_idol_df_long) 

#spread according to method
child_y1_fsbepicany_fsbepicidol_wide <- spread(child_y1_fsbepicany_fsbepicidol, method, percentage)
...
ggplot(child_y1_fsbepicany_fsbepicidol_wide, aes(x=FlowSorted.Blood.EPIC.any,
  ...
  ggsave(
    filename="2021-01-20_CHILD_y1_fsbepicany_fsbepicidol.tiff",
    device = "tiff",
    path =  here("figures", "deconvolution"),
    width = 3,
    height = 2.5,
...
#spread according to method
child_y1_fscbcany_fsbepicany_wide <- spread(child_y1_fscbcany_fsbepicany, method, percentage )
...
#spread according to method
child_y1_fscbcany_fsbepicboth_wide <- spread(child_y1_fscbcany_fsbepicboth, method, percentage )
...
ggplot(child_y1_fscbcany_fsbepicboth_wide, aes(x=FlowSorted.CordBloodCombined.450k,
  ...
  ggsave(
    filename="2021-01-20_CHILD_y1_fscbcany_fsbepicboth.tiff",
    device = "tiff",
    path =  here("figures", "deconvolution"),
    width = 3,
    height = 2.5,
...
#spread according to method
child_y1_fscbcany_fsbepicidol_wide <- spread(child_y1_fscbcany_fsbepicidol, method, percentage)


ggplot(child_y1_fscbcany_fsbepicidol_wide, aes(x=FlowSorted.CordBloodCombined.450k.any,
                                        y=FlowSorted.Blood.EPIC.IDOL)) +
  geom_point(aes(col=celltype), size=1) +
  facet_wrap( ~ celltype, ncol=2) +  
  geom_abline(intercept=0,slope=1) +
