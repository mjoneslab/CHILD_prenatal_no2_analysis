...
```{r load_rgset}
load(here("output_data", "preprocessed_data", "2021-09-24_child_rgset_nobadsamp.Rdata"))
```
...
child_fscbc_ecc2_cb_probelist_all <- probelist_all
child_fscbc_ecc2_cb_probelist_deconvo <- compData$coefEsts
...
child_fscbc_ecc2_y1_probelist_all <- probelist_all
child_fscbc_ecc2_y1_probelist_deconvo <- compData$coefEsts
```
...
save(child_fscbc_ecc2_cb, child_fscbc_ecc2_y1, 
     child_fscbc_ecc2_cb_probelist_all, child_fscbc_ecc2_cb_probelist_deconvo,
     child_fscbc_ecc2_y1_probelist_all, child_fscbc_ecc2_y1_probelist_deconvo,
     file=here("output_data","deconvolution", "2021-06-06_CBMC_PBMC_deconvolution.Rdata"))
```
