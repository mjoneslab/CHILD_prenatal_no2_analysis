...
prenatal_ids <- all_vars[all_vars$prenatal_c & all_vars$no2_preg_entire != 0, "sampleid"]

#get list of ids of participants in age one data
ageone_ids <- all_vars[all_vars$ageone_cc & all_vars$no2_preg_entire != 0 , "sampleid"]
...
#year one data
table1(~ no2_py1_entire + sex + maternal_smoking_y1 +
