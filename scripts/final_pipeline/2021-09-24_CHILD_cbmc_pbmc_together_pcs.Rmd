...
```{r save_PCs}
save(ccc_pcs,
     child_fscbc_ecc2_cb_probelist_all,
     child_fscbc_ecc2_cb_probelist_deconvo,
     child_fscbc_ecc2_y1_probelist_all,
     child_fscbc_ecc2_y1_probelist_deconvo,
     child_fscbc_ecc2_cb_df_nodups,
     child_fscbc_ecc2_y1_df_sub,
