...
write.csv(limma::topTable(cb_ebayes_sig, number=20, 
          ...
          here("tables", "prenatal", "2021-10-15_toptable_prenatal_10cpgs.csv"))
...
ggsave(plot = cb_cg27481559_PR,
       filename = here("figures", 
                       "linear_regression",
                       "prenatal",
                       "2021-10-15_cb_cg27481559_PR.png"),
...
ggsave(plot = cb_cg12228123_PR, 
       filename=here("figures", 
                     "linear_regression", 
                     "prenatal",
                     "2021-10-15_cb_cg12228123_AFAP1_PR.png"),
       width = 4.0, height = 3.2, units = "cm")
...
ggsave(plot = cb_cg12228123_raw,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_cb_cg12228123_AFAP1.png"),
       width = 3.7, height = 3.2, units = "cm")
...
ggsave(plot = global_dnam_PR,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_cb_global_dnam_PR.png"),
...
ggsave(plot = line_dnam_PR, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_cb_line_dnam_PR.png"),
       width = 4.2, height = 3.2, units = "cm")
...
write.csv(goi_df_pval_db, file=here("tables", "prenatal",
                                    "2021-10-15_goi_prenatal_cpgs.csv"))

# write table of top ten 
write.csv(goi_df_pval_db %>% 
            subset(db > 0.025 | db < -0.025) %>% 
            subset(-log10(p.value.no2_preg_entire) > 1.3) %>%
            arrange(p.value.no2_preg_entire),
          here("tables", "prenatal", "2021-10-15_top10goi_prenatal_cpgs.csv"))
...
write.csv(goi_df_pval_db_sig, here("tables", "prenatal", "2021-10-15_toptable_prenatal_goi.csv"))
...
ggsave(plot = cg12283362_PR,
       filename = here("figures",
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_cb_cg12283362_LONP1_PR.png"),
       width = 4.0, height = 3.2, units = "cm")
...
ggsave(plot = cg12283362_raw,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_cb_cg12283362_LONP1.png"),
       width = 4.0, height = 3.2, units = "cm")
...
ggsave(plot = cg08973675_PR, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_cb_cg08973675_SLC25A28_PR.png"),
       width = 4.0, height = 3.2, units = "cm")
...
ggsave(plot = cg08973675_raw, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2021-10-15_cb_cg08973675_SLC25A28.png"),
       width = 4.0, height = 3.2, units = "cm")
...
cb100_long <- cb100 %>% 
  mutate(dnam_dir = ifelse(db >= 0, 
                           "Increased DNAm at birth", 
                           "Decreased DNAm at birth"),
         db_cb = db) %>%
...
# plot 
top100_es_change <- ggplot(cb100_long, aes(x=name, y = value*100, group = cpgid, color = line_sig)) +
  geom_point(alpha = 0.5,  color = cb100_long$point_sig, size = 1) +
  geom_line(alpha = 0.5) +
  facet_wrap(~dnam_dir, scales = "free_y") +
...
ggsave(plot = top100_es_change,
       filename = here("figures",
                       "linear_regression", 
                       "prenatal",
                       "2021-11-10_top100_es_change.png"),
       height = 8, width = 9, units = "cm")
