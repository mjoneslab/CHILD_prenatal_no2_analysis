...
cb_cg27481559_plot <- ggplot(covariates_geno_ctpc_tech_cc,
  ...
  geom_ribbon(data = prenatal_no2_me, 
              ...
              alpha = .2) + 
  scale_y_continuous(limits = c(15,45), breaks=seq(20,40,10)) +
...
cb_cg12228123_plot <- ggplot(covariates_geno_ctpc_tech_cc,
  ...
  geom_ribbon(data= cb_cg12228123_no2_me, 
              ...
              alpha = .2) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
  scale_y_continuous(limits = c(50,100), breaks=seq(55,95,20)) +
  theme_bw() +
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=9),
        panel.border = element_blank(),
...
ggsave(plot = cb_cg12228123_plot,
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-05-06_cb_cg12228123_AFAP1.png"),
       width = 3.7, height = 3.2, units = "cm")
...
line_dnam_plot <- ggplot(covariates_geno_ctpc_tech_cc,
  ...
  geom_line(data = line_meth_no2_me, 
            aes(x=no2_preg_entire, y = line_meth*100),
            col="red", size=0.5, linetype="solid") +
...
ggsave(plot = cb_cg12283362_dnam_plot, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-05-06_cb_cg12283362_dnam.png"),
       width = 4.0, height = 3.2, units = "cm")
...
ggsave(plot = cb_cg08973675_dnam_plot, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-05-06_cb_cg08973675_dnam.png"),
       width = 4.0, height = 3.2, units = "cm")
...
# estimate marginal effects of prenatal NO2 exposure on DNAm
cg01610636_no2_me <- ggpredict(cg01610636_lm, terms = "no2_preg_entire") %>%
  as.data.frame() %>% 
  rename("cg01610636" = predicted,
         "no2_preg_entire" = x)

# plot 
cb_cg01610636_dnam_plot <- ggplot(covariates_geno_ctpc_tech_cc,
                                  aes(x = no2_preg_entire, 
                                      y= cg01610636*100)) + 
  geom_line(data = cg01610636_no2_me, 
            aes(x=no2_preg_entire, y = cg01610636*100),
            col="red", size=0.5, linetype="solid") +
  geom_ribbon(data = cg01610636_no2_me, 
              aes(x = no2_preg_entire, 
                  ymin = conf.low*100, ymax = conf.high*100), 
              alpha = .2) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
...
ggsave(plot = cb_cg01610636_dnam_plot, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-05-06_cb_cg01610636_dnam.png"),
       width = 4.0, height = 3.2, units = "cm")
...
# estimate marginal effects of prenatal NO2 exposure on DNAm
cg08491487_no2_me <- ggpredict(cg08491487_lm, terms = "no2_preg_entire") %>%
  as.data.frame() %>% 
  rename("cg08491487" = predicted,
         "no2_preg_entire" = x)

# plot 
cb_cg08491487_dnam_plot <- ggplot(covariates_geno_ctpc_tech_cc,
                                  aes(x = no2_preg_entire, 
                                      y= cg08491487*100)) + 
  geom_line(data = cg08491487_no2_me, 
            aes(x=no2_preg_entire, y = cg08491487*100),
            col="red", size=0.5, linetype="solid") +
  geom_ribbon(data = cg08491487_no2_me, 
              aes(x = no2_preg_entire, 
                  ymin = conf.low*100, ymax = conf.high*100), 
              alpha = .2) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
...
ggsave(plot = cb_cg08491487_dnam_plot, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-05-06_cb_cg08491487_dnam.png"),
       width = 4.0, height = 3.2, units = "cm")
...
# estimate marginal effects of prenatal NO2 exposure on DNAm
cg23400446_no2_me <- ggpredict(cg23400446_lm, terms = "no2_preg_entire") %>%
  as.data.frame() %>% 
  rename("cg23400446" = predicted,
         "no2_preg_entire" = x)

# plot 
cb_cg23400446_dnam_plot <- ggplot(covariates_geno_ctpc_tech_cc,
                                  aes(x = no2_preg_entire, 
                                      y= cg23400446*100)) + 
  geom_line(data = cg23400446_no2_me, 
            aes(x=no2_preg_entire, y = cg23400446*100),
            col="red", size=0.5, linetype="solid") +
  geom_ribbon(data = cg23400446_no2_me, 
              aes(x = no2_preg_entire, 
                  ymin = conf.low*100, ymax = conf.high*100), 
              alpha = .2) + 
  geom_point(alpha=0.6, col = "#254A90", size=1) + 
...
ggsave(plot = cb_cg23400446_dnam_plot, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-05-06_cb_cg23400446_dnam.png"),
       width = 4.0, height = 3.2, units = "cm")
...
ggsave(plot = y1_cg27481559_dnam_plot, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-05-06_y1_cg27481559_dnam.png"),
       width = 3.7, height = 3.2, units = "cm")
...
ggsave(plot = y1_cg12228123_dnam_plot, 
       filename = here("figures", 
                       "linear_regression", 
                       "prenatal",
                       "2022-05-06_y1_cg12228123_dnam.png"),
       width = 3.7, height = 3.2, units = "cm")
...
ggsave(plot = top100_es,
       filename = here("figures",
                       "linear_regression", 
                       "prenatal",
                       "2022-05-06_top100_es_change.png"),
